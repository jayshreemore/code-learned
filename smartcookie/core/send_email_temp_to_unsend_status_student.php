...
$i=1;
	...
	$start = $_POST['start'];
	$end = $_POST['end'];
$query2 = "select std_country,std_phone,std_password,std_email,std_school_name from `tbl_student` where email_status='Unsend' and  school_id='$School_id' limit $start,$end";
...
echo "$success emails sent successfully $fail emails failed";
