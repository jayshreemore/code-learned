...
<div class="container" style="padding:30px;">
             ...
             <a href="manager_setup.php"><input type="submit" class="btn btn-primary" name="submit" value="Add Manager" style="width:150;font-weight:bold;font-size:14px;"/></a>
...
<tr style="background-color:#555;color:#FFFFFF;height:30px;" ><th >Sr.No</th><th>Profile Picture</th><th >Manager ID</th><th>ManagerName</th><th >Phone No.</th>

					 <th >Email ID</th><th>Department</th><th >No of Projects</th><th>Edit</th><th>Delete</th></tr>
                ...
                <td ><?php echo $row['t_id'];?></td>
				    ...
				    <td ><?php echo $row['t_dept'];?> </td>
					 ...
					 <?php	$sql=mysql_query("select count(s.tch_sub_id) as count from tbl_teacher_subject_master s join  tbl_academic_Year y on s.AcademicYear=y.Academic_Year and s.`ExtYearID`=y.ExtYearID and y.Enable='1' where s.teacher_id='$t_id' and y.school_id='$sc_id'"); 
				  ...
				  <td ><a href="edit_manager_details.php?t_id=<?php echo $row['t_id'];?>"><center><img src="images/edit.png" height="20px" width="20px"></a></center></td>
