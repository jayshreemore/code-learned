...
<td > <a href="assign_greenpoints.php?school_id=<?php echo $school_id;?>"> <input type="button" value="Assign" name="assign" class="btn" style="background-color: #3DBD2F;
    border-color: #3DBD2F;"/></a></td>
