...
<div style="bgcolor:#CCCCCC">
    ...
    <div class="" style="padding:25px; width:2276px;">
            ...
            <div style="background-color:#F8F8F8 ;">
                <div class="row">
                    <div class="col-md-3 " style="color:#700000 ;padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="add_branch_subject_division_year.php"><input type="submit" class="btn btn-primary" name="submit"
                    ...
                    <div class="col-md-12" id="no-more-tables">
                        ...
                        <table id="example" class="display" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th style="width:40px;">
                                    <center>SubjectTitle/SubjectID/SubjectCode</center>
                               ...
                               <!-- <th style="width:50px;">
                                ...
                                <th style="width:50px;">
                                    <center>SubjectShortName/SubjectType</center>
                                </th>
<!--                                <th style="width:50px;">-->
...
<!--
                                ...
                                <th style="width:50px;">
                                    <center>BranchName/BranchID</center>
                                </th>
                               <!-- <th style="width:50px;">
                             ...
                             <!--   <th style="width:50px;">
                                ...
                                <th style="width:50px;">
                                    <center>DivisionName/DivisionId</center>
                                </th>
                               <!-- <th style="width:50px;">
