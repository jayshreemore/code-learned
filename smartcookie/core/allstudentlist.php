...
-webkit-border-radius: 99em;
  ...
  width:100px;
   ...
   <div class="row" style="padding-top:20px; padding-left:20px; margin-top:-20px;" align="center">
   <div class="col-md-12">
	...
	?>
      ...
      <div  class="col-md-9" style="border:1px solid #CCCCCC; background-color:#FFFFFF;">
          ...
          <div class="row" align="center">
              <div class="" style="padding:7px 0px 7px 7px; background-color:#333333; color:#FFFFFF;">
                   My Students
                </div>
          </div>
...
//echo $query;die;		 
       ...
       <div class="row" align="center" style="padding-top:-1px; border-bottom:1px solid #ccc; padding-bottom:12px;">
         <h4> Subject Name: <?php echo $testresult['subjectName'];?></h4>
         </div>
...
//$sql=mysql_query("SELECT distinct ss.`std_PRN`,ss.school_id,ss.`std_div`,ss.std_complete_name,ss.std_name,ss.std_lastname,ss.std_img_path,ss.std_Father_name FROM tbl_student ss inner join tbl_request r on r.stud_id1 = ss.std_PRN  WHERE r.flag='Y' and r.stud_id2='$t_id'");
...
<?php
	 ...
	 {
	 ?>
<div  class="col-md-8 col-md-offset-1" style="border:1px solid #CCCCCC; background-color:#FFFFFF;" align="center">
<div class="row">
<div class="" style=" background-color:#333333; text-align:center; padding:7px 0px 7px 7px; color:#FFFFFF;"> My Students</div>
</div>
...
/*echo "SELECT distinct ss.`std_PRN`,ss.school_id,ss.`std_div`,ss.std_complete_name,ss.std_name,ss.std_lastname,ss.std_img_path,ss.std_Father_name,ss.std_branch FROM tbl_student ss inner join tbl_request r on r.stud_id1 = ss.std_PRN  WHERE r.flag='Y' and r.stud_id2='$t_id'";die;*/
$rowall4=mysql_query("SELECT distinct ss.`std_PRN`,ss.school_id,ss.`std_div`,ss.std_complete_name,ss.std_name,ss.std_lastname,ss.std_img_path,ss.std_Father_name,ss.std_branch,std_year,std_div FROM tbl_student ss inner join tbl_request r on r.stud_id1 = ss.std_PRN  WHERE r.flag='Y' and r.stud_id2='$t_id'");
...
<td style="padding:10px;" align="center"><?php echo $result4['std_div'];?></td>
<td style="padding:10px;" align="center"><?php echo $result4['std_branch'];?></td>

<td style="padding:10px;" align="center"><?php echo $result4['std_year'];?></td>
<?php
$arra=mysql_query("select sc_total_point  from  tbl_student_reward where sc_stud_id ='$std_PRN'");
$test3=mysql_fetch_array($arra);
?>
