   ...
   <table id="example" class="display" width="100%" cellspacing="0">
        ...
        <tbody>
         ...
         function checkEntity($entity)
         {
          ...
          $sql = "SELECT * FROM `tbl_ActivityLog` WHERE school_id='".$school_id."' order by ActivityLogID";
          ...
          while ($row = mysql_fetch_assoc($query))
          {
            /*Entity 1  */
             ...
             $sql1 = "SELECT ".$data['name']." as name from ".$data['table']." WHERE ". $data['id']."='".$row['EntityID']."'";
             $q = mysql_query($sql1);
            ...
            /* Entity 2    */
             ...
             $Ent2_name = mysql_fetch_array(mysql_query($sql2));

            /* Device Information */
             $device = mysql_fetch_array(mysql_query("SELECT `LatestMethod`,`LatestDeviceDetails`,`CountryCode` FROM `tbl_LoginStatus` WHERE `EntityID`='".$row['EntityID']."' AND`Entity_type`='".$row['Entity_type']."'"));
