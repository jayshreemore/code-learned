...
<body>
    	...
    	<div style=" background-color:#ccc;width:100%;margin-left:100px;margin-right:200px;  align:center;border:1px solid #CCCCCC;" align="left">

        	<h2 style="padding:7px 0px; font-size:22px ;margin:5px 0px; color:white;text-align:center;background-color:#2F329F;">My Soft Reward</h2>
...
<div style="padding-top:10px;">
  ...
  <table  id="keywords" class="table-bordered"  style="width:100%; border-color:#000000;" align="center">
    <thead class="cf">
      <tr align="center">
        ...
        <th style="width:10px;color:white;background-color:#2F329F;">Reward Points</th>
                <th style="width:10px;color:white;background-color:#2F329F;">Reward Date</th>
    ...
    <tbody>
		...
		$sql=mysql_query("select r.imagepath,r.rewardType,s.point,s.date from  softreward r INNER JOIN purcheseSoftreward s on r.`softrewardId`=s.reward_id where s.userType='teacher' and s.user_id='$id'  order by  id DESC");
		$i=0;
                ...
                <tr>
                   ...
                   <td data-title="Sr.No" width="5px;" align="center" >  <img src="<?php echo $result['imagepath'];?>" class="preview" style=" width:64px;height:64px;" alt="" /></td>
                    ...
                    <td data-title="Sr.No" width="5px;" align="center" ><b><?php echo $result['rewardType'];?></b></td>
                     <td data-title="Sr.No" width="5px;" align="center" ><b><?php echo $result['point'];?></b></td>
                       <td data-title="Sr.No" width="5px;" align="center" ><b><?php echo $result['date'];?></b></td>
