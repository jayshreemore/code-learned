...
if(isset($_POST['submit']))
{
	...
	if(isset($_POST['activity']))
		...
		mysql_query("insert into tbl_student_point(sc_stud_id,sc_entites_id,sc_teacher_id,sc_studentpointlist_id,sc_point,marks,point_date,sc_status,method,activity_type,school_id,comment) values('$std_PRN','$entites_id','$teacher_id','$reason_id','$point','$marks','$point_date','N','$method','$activity_type','$sc_id','$pointreason')");
							...
							//echo "efre";echo $row_count ;echo "grg";die;
							if($row_count == 1 || $row_count > 1)
							{
								...
								$sc_total_point = $row_points1['sc_total_point']+ $point; 
								 //echo "update tbl_student_reward set sc_total_point = '$sc_total_point' where sc_stud_id = '$std_PRN' and school_id='$school_id'";die;
							...
							elseif($row_count == 0)
							{
								...
								//echo"insert into tbl_student_reward(sc_total_point,sc_stud_id,sc_date,school_id) values('$point','$std_PRN','$point_date','$school_id')";
   ...
   // echo 'alert("Successfully Registered")'; 
    echo '</script>';							
							...
							//calling master action log webservice
   ...
   // echo 'alert("Successfully Registered")'; 
    echo '</script>';							
								...
								//echo"select gc.gcm_id,std_name,std_lastname from student_gcmid  gc left outer join tbl_student s on  gc.std_PRN=s.std_PRN where gc.std_PRN='$std_PRN'";
...
WHERE sm.student_id = '$std_PRN' AND sm.school_id='$school_id' AND Enable='1' AND sm.teacher_ID='$teacher_id'");
                      ...
                      <div class="col-md-3"  style="padding-top:5px;" >
                           <h4 align="left">Art</h4>
                            ...
                            <?php
								$query1 = mysql_query("SELECT sp.sc_list,sc_id FROM tbl_studentpointslist sp JOIN tbl_activity_type a WHERE sp.school_id= '$school_id' AND a.activity_type = 'Arts' AND a.id = sc_type");
								while($row = mysql_fetch_array($query1))
								{
							?>
