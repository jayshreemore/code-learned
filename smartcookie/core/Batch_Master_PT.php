             ...
             <div class="col-md-12  " id="no-more-tables" >
               <?php $i=0;?>
                  <table class="table-bordered" id="example" width="100%;" >
					 ...
					 <th style="width:30%;"><b>Uploaded_Batch_ID</b></th>
					 <th style="width:30%;" >Input File name</th>
					 <th style="width:20%;"><b>Uploaded Date and Time</b></th>
					 <th style="width:20%;">Uploaded Records </th>
					<th style="width:20%;">Errors Records</th>
					<th style="width:20%;">Duplicate Records</th>
					<th style="width:20%;">Correct Records</th>
					<th style="width:20%;">Updated Records</th>
					<th style="width:10%;">Inserted Records </th>
					<th style="width:10%;">Existing Records </th>
                 ...
                 <tr>
					...
					<td style="width:20%;"><?php echo $row['batch_id'];?></td>
					...
					<td style="width:10%;"><?php echo $row['num_newrecords_inserted'];?> </td>
					<td style="width:10%;"><?php echo $row['existing_records'];?> </td>
...
<div class="dropdown" id="drop" style="padding-left:500px">
 ...
 <?php if(isset($tbl_name)){echo $tbl_name;} else echo 'Table Name';?>
    <span class="caret"></span>
  </button>

  <ul class="dropdown-menu"  role="menu" aria-labelledby="dropdownMenu1" style="margin-left:502px;">
  
   <?php $sql1=mysql_query("Select distinct display_table_name from tbl_Batch_Master group by display_table_name" );?>
             ...
             <div class="col-md-12  " id="no-more-tables" >
               <?php $i=0;?>
                  <table class="table-bordered" id="example"  >
                     <tr style="background-color:#428BCA" >
					 <th style="width:10%;" ><b>Sr.No</b></th>
					 <th style="width:20%;"><b>Uploaded_Batch_ID</b></th>
					 <th style="width:30%;" >Input File name</th>
					 <th style="width:20%;"><b>Batch_Date</b></th>
					 <th style="width:20%;"><b>Batch_Time</b></th>
					 <th style="width:20%;">Uploaded Records </th>
					<th style="width:20%;">Errors Records</th>
					<th style="width:20%;">Duplicate Records</th>
					<th style="width:20%;">Correct Records</th>
                 ...
                 <?php
				   ...
				   $i=1;
				  $arr=mysql_query("select * from tbl_Batch_Master where display_table_name='$tbl_name' and `school_id`='$sc_id' group by `batch_id` order by `uploaded_date_time` DESC ");?>
				  <?php while($row=mysql_fetch_array($arr)){
                 ...
                 <tr>
                    <td style="width:10%;"><?php echo $i;?></td>
					<td style="width:20%;"><a href="All_Batch_MasterPT.php?batch_id=<?php echo $row['batch_id'];?>&table_name=<?php echo $tbl_name;?>&records_size=<?php echo $row['num_records_uploaded'];?>"><?php echo $row['batch_id'];?></td>
                    <td style="width:15%;"><?php echo $row['input_file_name'];?></td> 
