...
<li role="presentation"><a role="menuitem" tabindex="-1" href="SendMSG_branch_Student.php?std_branch=<?php echo $row['std_branch'];?>&school_id=<?php echo $row['school_id'];?>&status=<?php echo $row['send_unsend_status'];?>&country=<?php echo $row['std_country'];?>"><?php echo $row['std_branch'];?><?php }?> </a></li>
               ...
               <?php $i=0;?>
                  <table class="table-bordered  table-condensed cf" id="example" width="100%;" >
                     <thead>
                    	<tr style="background-color:#428BCA" ><th style="width:10%;" ><b>Sr.No</b></th><th style="width:20%;"><b>Student PRN</b></th><th style="width:20%;" >First Name</th><th style="width:30%;" >Last Name</th><th style="width:20%;">Phone No.</th><th style="width:20%;">Email ID</th> </th><th style="width:10%;">Department</th> </th><th style="width:10%;">Message Status</th>  
                        <th style="width:15%;">Send SMS/Email</th>
                        </tr></thead><tbody>
                 <?php
				 
				   $i=1;
				   echo "select * from tbl_student where school_id='$School_id' and error_records like 'Correct' and std_dept like '$dpt_id' order by id";
				  
				  $arr=mysql_query("select * from tbl_student where school_id='$School_id' and error_records like 'Correct' and std_dept like '$dpt_id' order by id");?>
				  ...
				  ?>
					...
					<td data-title="Name" style="width:12%;"><?php echo $row['std_lastname']?></td> 
				     ...
				     <td data-title="Phone" style="width:8%;"><?php echo $row['std_email'];?> </td>
				      <td data-title="Phone" style="width:6%;"><?php echo $row['std_dept'];?> </td>
