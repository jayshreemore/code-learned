               ...
               <?php $i=0;?>
                  ...
                  <table id="example" class="display" width="100%" cellspacing="0">
                     ...
                     <thead>
                    	...
                    	<tr ><th><b><center>Branch ID</center></b></th><th  ><center>Branch Name </center></th><th  ><b><center>Branch code</center></b></th><th  ><b><center>Department Name</center></b></th><th ><b><center>Course Level</center></b></th><th ><b><center>Degree</center></b></th><th>Batch ID</th></tr></thead><tbody>
				...
				<?php
                 ...
                 <tr style="height:40px;"><th style="width:100px;" ><b><center> <?php echo $row['ExtBranchId'];	?></center></b></th><th style="width:150px;" ><center> <?php echo $row['branch_Name'];?></center> </th><th style="width:100px;" ><b><center><?php echo $row['Branch_code'];?></center></b></th><th style="width:100px;" ><b><center><?php $dept_id= $row['Dept_Id'];
				...
				echo $dept_name;
                 ...
                 <th style="width:100px;" ><b><center><?php echo $row['Course_Name'];?></center></b></th>

                    <th style="width:100px;" ><b><center><?php $degree_code= $row['degree_code'];
