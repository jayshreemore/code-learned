...
$(document).ready(function() {
	...
	if(obj.posts.data[0].photo==""){
		...
		document.getElementById("photo").innerHTML="<img src='"+"<?php echo base_url(); ?>"+obj.posts.data[0].photo+"' height='75px' width='75px'> ";
	}		}
				}
			}
		});
...
<button class="btn btn-success" name="sccodebtn" id="sccodebtn" >Search</button>
		...
		<div class="row">Coupon Code#:&nbsp;<span id="couponid" style="font-weight:bold;" ></span></div>
		...
		<div class="row">Institute Name:&nbsp;<span id="school_name" style="font-weight:bold;" ></span></div>						
				</div>
				<div class="col-md-2">
						<div class="row">
							 <span id="photo"></span>
			...
			<div class="row">
				...
				<div class="row">
<div class="col-md-3">
	<input type="radio" name="otype" value="Product" checked> Product
</div>
<div class="col-md-3">
...
<div class="col-md-2">
	<input name="propoints" class="form-control" id="propoints" placeholder="Points" type="text" disabled>
				...
				<div class="row"  >
<div class="col-md-3">
	<input type="radio" name="otype" value="Discount"> Discount
</div>		
						<div class="col-md-3">
	<select name="coupon_used_for" class="form-control" id="discount_name" onchange="discountSelected()">
		<option value="select" selected="selected">Select any one</option>
			<?php foreach($discount as $key =>$value){ 
				...
				<div class="row" >
<div class="col-md-3">
	<input type="radio" name="otype" id="Miscellaneous" value="Miscellaneous"> Miscellaneous
</div>				
						<div class="col-md-3">
