...
<div class=''>
<div class="form-group has-success">
<input   class="form-control"  type="text" name="tid" placeholder="Teacher Id" value="<?php if(isset($_POST['tid'])) { echo $_POST['tid']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
...
<input  class="form-control"  type="text" name="subtitle" placeholder="Subject Name" value="<?php if(isset($_POST['subtitle'])) { echo $_POST['subtitle']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
...
<div class=''>
<div class="form-group has-success">
<input  class="form-control"  type="text" name="subcode" placeholder="Subject Code" value="<?php if(isset($_POST['subcode'])) { echo $_POST['subcode']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
...
<div class=''>
<div class="form-group has-success">
<input  class="form-control"  type="text" name="branch" placeholder="Branch" value="<?php if(isset($_POST['branch'])) { echo $_POST['branch']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
