...
<div style="height:20px;"></div>
        <div style="height:10px;" ></div>
    	<div style="height:50px; background-color:#FFFFFF; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;" align="left">
        	<h2 style="padding-left:20px; margin-top:2px;color:#666">Green Points given to Manager for Distribution</h2>
        </div>
        <div   class="container" style="padding-top:20px;">
                ...
                $arrs = mysql_query("select tp.sc_point,point_date,sc_teacher_id,reason,t.tc_used_point,t.t_complete_name from tbl_teacher_point tp join tbl_teacher t on tp.sc_teacher_id = t.t_id AND tp.school_id = '$school_id' where t.school_id='$school_id'");
