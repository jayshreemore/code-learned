             ...
             <div class="col-md-12  " id="no-more-tables" >
               <?php $i=0;?>
                 ...
                 <?php
				   ...
				   $i=1;
				  $arr=mysql_query("select * from  tbl_raw_teacher where `error_records`='$duplicate' and t_school_id='$sc_id' order by id");?>
...
<div class="container"  style="padding:30px;" >
               ...
               <?php $i=0;?>
                  <table class="table-bordered  table-condensed cf" id="example" width="100%;" >
                     <thead>
                    	 <tr style="background-color:#428BCA" ><th style="width:6%;" ><b>Sr.No</b></th><th style="width:20%;"><b>Teacher ID</b></th><th style="width:25%;" >First Name</th><th style="width:25%;" >Middle Name</th><th style="width:30%;" >Last Name</th><th style="width:20%;">Phone No.</th><th style="width:20%;">Email ID</th><th style="width:20%;">Department</th><th style="width:20%;">Gender</th><th style="width:20%;">Error Status</th></tr>
                 ...
                 <?php
				   ...
				   $i=1;
				  $arr=mysql_query("select * from `tbl_raw_teacher` where t_school_id='$sc_id' and batch_id='$B_id' and (error_records like 'Err-Tid' OR error_records like 'Err-Name')");?>
                  <?php while($row=mysql_fetch_array($arr)){
				  $teacher_id=$row['id'];
				  ?>
                  <tr>  <!--onmouseover="this.style.cursor='pointer';this.style.textDecoration='underline';this.style.color='dodgerblue'" onmouseout="this.style.textDecoration='none';this.style.color='black';"  onclick="window.location='teachers_subjects.php?t_id=<?php echo $row['t_id'];?>'"class="d0" style="padding-top:2px;color:#808080">-->
                    ...
                    <td data-title="Sr.No" style="width:6%;" ><b><?php echo $i;?></b></td>
					<td data-title="Teacher ID" style="width:10%;" ><b><?php echo $row['t_id'];?></b></td>
                    <td data-title="Name" style="width:18%;"><?php echo $row['t_name']?></td> 
                    <td data-title="Name" style="width:18%;"><?php echo $row['t_middlename']?></td> 
					<td data-title="Name" style="width:20%;"><?php echo $row['t_lastname']?></td> 
                         <td data-title="Phone" style="width:10%;"><?php echo $row['t_phone'];?> </td>
						  <td data-title="Phone" style="width:0%;"><?php echo $row['t_email'];?> </td>
						 <td data-title="Department" style="width:9%;"><?php echo $row['t_dept'];?> </td>
						 <td data-title="Gender" style="width:10%;"><?php echo $row['t_gender'];?> </td>
						  <td data-title="Gender" style="width:10%;"><?php echo $row['error_records'];?> </td>
