...
<div  class="col-md-9" style="border:1px solid #CCCCCC; background-color:#FFFFFF;">
<div class="row">
<div class="" style=" background-color:#333333; text-align:center; padding:7px 0px 7px 7px; color:#FFFFFF;"> My <?php echo ($_SESSION['usertype']=='Manager')? 'Employees':'Students';?></div>
</div>
