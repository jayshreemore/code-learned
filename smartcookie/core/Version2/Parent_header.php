        ...
        <div class="row">
              ...
              <div class="col-md-2 col-md-offset-5" style="padding-right:10px;" >
            	<div style="padding:5px; width:100%;" align="center">
                 ...
                 <?php if($p_img!=""){?>
                <img src="<?php echo $p_img;?>" width="60" height="60" style="border:1px solid #CCCCCC;" class="preview" alt="Responsive image" />
                <?php }else {?> <img src="image/avatar_2x.png" width="60" height="60" style="border:1px solid #CCCCCC;" class="img-responsive" alt="Responsive image"/> <?php }?>
                &nbsp;
                </div>
             </div>
             <div class="col-md-3">
              ...
              <div class="container" >
                ...
                <div class="collapse navbar-collapse" id="b-menu-1" style="border-color:#428BCA;">
                  ...
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <li color:#FFFFF><a href="purchase_point.php">Home</a></li>
                    ...
                    <li><a class="dropdown-toggle" data-toggle="dropdown"  href="#">Purchase coupons</a>
                             <ul class="dropdown-menu">
                                  ...
                                  <li><a href="parent_greenpoint_coupon.php">Green points coupons</a></li>
                    ...
                    <li><a class="dropdown-toggle" data-toggle="dropdown"  href="#">Log</a>
                             <ul class="dropdown-menu">
                                  ...
                                  <li><a href="parent_greenpoint_log.php">Green points Log</a></li>
                                  <li><a href="parent_bluepoint_log.php">Blue points Log</a></li>
                                    
                                      <li><a href="greenpointcoupon.php">Green points Coupon Log</a></li>
