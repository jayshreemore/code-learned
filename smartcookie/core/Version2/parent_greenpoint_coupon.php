		 ...
		 if(isset($_POST['submit']))
			 ...
			 // mysql_query("update tbl_giftof_rewardpoint set parent_id='$parent_id' where coupon_id='$coupon_id'");
                  ...
                  if(mysql_num_rows($row)>0)
                  {
        			    ...
        			    mysql_query("insert into tbl_giftof_rewardpoint(coupon_id,point,issue_date,entity,user_id)values('$coupon_id','$point','$date1','106','$parent_id')");

			        	$report="You  got ".$point. " Water Points";
                }
			  else
			  {
