...
//Save
if($obj->{'User_Std_id'} != ''&& $obj->{'t_id'}!='' && $obj->{'method_id'}!='')
{
		//input from user
		...
		if($method_id==2 or $method_id==3 or $method_id==4)
		{
		...
		WHERE t.id ='$method_id' AND activity_id='$activity_id' AND subject_id='$subject_id' AND school_id='$school_id'";
				...
				$postvalue['responseMessage']="No Response 1";
				...
				else
				{
					...
					$values=mysql_fetch_array($results);
					 ...
					 $arr1=mysql_query("select tc_balance_point,t_name,t_middlename,t_lastname from tbl_teacher where t_id='$teacher_id'");
						 ...
						 mysql_query("update tbl_teacher set tc_balance_point='$balance_point' where t_id='$teacher_id' and school_id='$school_id'");
							...
							mysql_query("INSERT INTO `tbl_student_point` (sc_stud_id, sc_entites_id, sc_teacher_id, sc_studentpointlist_id, sc_point, point_date, sc_status,activity_type,marks,method,school_id) VALUES('".$obj->{'User_Std_id'}."', '103', '".$obj->{'t_id'}."', '$activity_id', '$points', '$dates', 'N','activity','$value','$method_id','$school_id')");
							  ...
							  mysql_query("INSERT INTO `tbl_student_point` (sc_stud_id, sc_entites_id, sc_teacher_id, sc_studentpointlist_id, sc_point, point_date, sc_status,activity_type,marks,method,school_id) VALUES('".$obj->{'User_Std_id'}."', '103', '".$obj->{'t_id'}."','$subject_id', '$points', '$dates', 'N','subject','$value','$method_id','$school_id')");
					...
					$report="Points successfully assigned";
		...
		$postvalue['posts']=$posts;
					...
					{
						$postvalue['responseStatus']=204;
				$postvalue['responseMessage']="No Response 2";
				$postvalue['posts']=null;	
 ...
 $arr1=mysql_query("select tc_balance_point,t_name,t_middlename,t_lastname from tbl_teacher where t_id='$teacher_id' and school_id='$school_id'");
	...
	$balance_point=$val['tc_balance_point'];
	 ...
	 if($balance_point>=$value)
	 {
				 ...
				 mysql_query("INSERT INTO `tbl_student_point` (sc_stud_id, sc_entites_id, sc_teacher_id, sc_studentpointlist_id, sc_point, point_date, sc_status,activity_type,marks,method,school_id) VALUES('".$obj->{'User_Std_id'}."', '103', '".$obj->{'t_id'}."', '$activity_id', '$value', '$dates', 'N','activity','','$method_id','$school_id')");
				 //retrive activity name for particular activity id(monika)
			 ...
			 $reasonofreward=$value_activity['sc_list'];
				 ...
				 else
				 {
				  ...
				  mysql_query("INSERT INTO `tbl_student_point` (sc_stud_id, sc_entites_id, sc_teacher_id, sc_studentpointlist_id, sc_point, point_date, sc_status,activity_type,marks,method,school_id) VALUES('".$obj->{'User_Std_id'}."', '103', '".$obj->{'t_id'}."','$subject_id', '$value', '$dates', 'N','subject','','$method_id','$school_id')");
				  //retrive subject name for particular subject id(monika)
	...
	{
		$postvalue['responseStatus']=204;
				$postvalue['responseMessage']="No Response 3 $balance_point>=$value";
				$postvalue['posts']=null;	
