	...
	if($school_id != "")
		{
		 ...
		 $sql= "SELECT sp.sc_id,sp.sc_list,a.activity_type FROM tbl_studentpointslist sp JOIN tbl_activity_type a WHERE sp.school_id='$school_id'  AND a.id = sp.sc_type";
 			 $arr = mysql_query($sql);
