...
//input from user
	...
	if( $teacher_id != "" && $school_id!='' )
		{
	$arr=mysql_query("SELECT tc_balance_point as green_points, balance_blue_points as blue_points,water_point,brown_point from tbl_teacher where t_id='$teacher_id'  ");
