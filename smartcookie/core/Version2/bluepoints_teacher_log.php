...
<div class="container">
    <div  style="width:100%;">
    	...
    	<div style="height:50px; background-color:#FFFFFF; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;" align="left">
        	<h2 style="padding-left:20px; margin-top:2px;color:#666">Teacher Blue points Log</h2>
...
<div id="no-more-tables" style="padding-top:20px;">
            <table class="col-md-12 table-bordered table-striped table-condensed cf" align="center" style="width:100%">
        		<thead class="cf">
                    ...
                    <th width="15%"><center>Teacher  Name</center></th>
			...
			$i=$rec_limit*$page;
            	...
            	$arrs = mysql_query("select tp.sc_point,t_list,point_date,sc_teacher_id,t.t_name from tbl_teacher_point tp join tbl_teacher t on tp.sc_teacher_id = t.t_id join tbl_thanqyoupointslist on tbl_thanqyoupointslist.id=sc_thanqupointlist_id where t.school_id='$school_id' ORDER BY tp.id DESC LIMIT $offset, $rec_limit");
                ...
                <tbody>
                 <tr>
                    ...
                    <td data-title="Teacher Name"  width="15%"><?php echo $teacher['t_name'];?></td>
