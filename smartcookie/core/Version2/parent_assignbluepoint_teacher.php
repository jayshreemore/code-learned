            ...
            if(isset($_POST['assign']))
				{
					...
					if($arr['balance_points']>=$point)
					{
						...
						mysql_query("insert into tbl_teacher_point(sc_teacher_id,sc_entities_id,assigner_id,sc_point,sc_thanqupointlist_id,point_date) values('$id','106','$user_id','$point','$activity_id','$assign_date')");
						$report= "You have assigned $point blue points.";
