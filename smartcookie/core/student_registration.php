    ...
    <div class='panel panel-primary dialog-panel'>
      ...
      <div class='panel-body'>
        <form class='form-horizontal' role='form' method="post">
          ...
          <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_title'>Student Name</label>
            <div class='col-md-8'>
              <div class='col-md-2'>
           ...
           <div class='form-group'>
            ...
            <div class='col-md-8'>
              <div class='col-md-2'>
                <div class='form-group internal'>
                  <select class='form-control' id='id_title' name="id_title1">
                    <option>Mr</option>
                    <option>Ms</option>
                    <option>Mrs</option>
                    <option>Miss</option>
              ...
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
                  <input class='form-control' id='id_first_name' name="id_first_name1" placeholder='First Name' type='text'>
                </div>
              </div>
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
                  <input class='form-control' id='id_last_name' name="id_last_name1" placeholder='Last Name' type='text'>
                </div>
              </div>
            </div>
          </div>
         ...
         <!-- <div class='form-group'>
          ...
          <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_email'>Username</label>
            <div class='col-md-6'>
              <div class='form-group'>
                <div class='col-md-6'>
                  <input class='form-control' id='id_password' name="id_username" placeholder='' type='text'>
                </div>
              </div>
