...
<div class="container" style="padding:25px;" >
            	...
            	<div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4; width:120%;">
...
<div class="container"  style="padding:30px;" >
            	...
            	<div style="border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4; width:120%;">
             ...
             <div class="col-md-12  " id="no-more-tables" >
               ...
               <?php $i=0;?>
				...
				$errorName=$_GET['error'];
				  ...
				  $arr=mysql_query("select * from tbl_teachr_subject_row where status='$errorName'");?>
                  <?php while($row=mysql_fetch_array($arr))
				  {
                 ...
                 <tr style="height:30px;color:#808080;">
                    ...
                    <th style="width:50px;"><center><?php echo $row['CourseLevel'];?></center> </th>
                     <th style="width:50px;"><center><?php echo $row['AcademicYear'];?></center> </th>
