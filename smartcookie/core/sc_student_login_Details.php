...
$row=mysql_query("Select EntityID,school_id,LatestLoginTime,LogoutTime from tbl_LoginStatus  where Entity_type='105' AND school_id = '$school_id' ");
...
<body>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" align='center'><h3> Student Login Logout Details</h3></div>
