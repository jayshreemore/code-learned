...
<div class="container" style="padding:25px;" >
         ...
         <form method="post"  >
          ...
          </div>		  <div class="row " >                  <div class="col-md-3 col-md-offset-2" align="left" style="color:#003399;font-size:16px">                 <b> Project Deliver Date</b>                  </div>                  <div class="col-md-5 form-group">                                                            <input type="text" name="subject" id="subject" class="form-control" style="width:100%; padding:5px;" placeholder=":Enter Subject" value='<?php echo $subject; ?>'/>                  </div>          </div>
          <div class="row " >
