...
document.getElementById("cancel").innerHTML = '';
	...
	document.getElementById("email").innerHTML='<input type="text" id="std_email" name="std_email" value="<?php echo $value['std_email'];?>">';
	...
	document.getElementById("email").innerHTML='<?php echo $value['std_email'];?>';
