...
<div class="container"  style="padding:30px;" >
            	...
            	<div style="border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;
                       <a href="Admin_Staff_setup.php"><input type="button" class="btn btn-primary" name="submit" value="Add Staff" style="width:150;font-weight:bold;font-size:14px;"/></a>
               			 </div>
               ...
               <?php $i=0;?>
				...
				<td>	<a href="Update_Admin_Staff_setup.php?staff_d=<?=$schoo_staff_id; ?>" style="width:100px;">Edit </a>
      <!--  <td><a href="Update_Admin_Staff_setup.php?staff_d=<?//=$schoo_staff_id; ?>"><span class='glyphicon glyphicon-pencil'></span>
    </a>  -->
	</td>            
                 
         <td style="width:100px;" ><center> <a onClick="confirmation(<?php echo $schoo_staff_id; ?> )">Delete</a></center></td>           
