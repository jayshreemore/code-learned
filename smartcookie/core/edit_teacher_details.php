...
if ($t_id != '') {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if ($t_id != '') {
            ...
            $sql_update11 = "UPDATE `tbl_teacher` SET t_complete_name='$complete_name',t_qualification='$edu',t_dob='$dob1',t_email='$e_id',
			t_exprience='$experience',t_dept='$department',t_gender='$gen',t_internal_email='$internal_emailid',t_phone='$mob',t_landline='$land',
			t_address='$address',t_country='$country',state='$state',t_city='$cty',CountryCode='$CountryCode'
...
<div class='container'>
    ...
    <div class='panel-body'>
        <form class='form-horizontal' role='form' method="POST">
            ...
            <div class='form-group'>
                <label class='control-label col-md-2 col-md-offset-2' for='id_checkin' style="text-align:left;">Date OfBirth</label>
                <div class='col-md-8'>
                    <div class='col-md-5'>
...
color: #777;">
            ...
            <div class='form-group'>
                ...
                <div class='col-md-3'>Email<input class='form-control' id='id_email' name="id_email" type='text' style="width: 300px;" value=<?php echo $email; ?>></div>
            ...
            <div class='form-group'>
                <label class='control-label col-md-2 col-md-offset-2' for='id_email' style="text-align:left;"></label>
                <div class='col-md-3'>country code<input class='form-control' id='CountryCode' name="CountryCode" type='text' value="<?php echo $country_code; ?> "></div>
                <div class='col-md-3 indent-small' id="errorCountryCode" style="color:#FF0000">
                </div>
            </div>
            <div class='form-group'>
                <label class='control-label col-md-2 col-md-offset-2' for='id_email' style="text-align:left;"></label>
            ...
            <div class='form-group'>
                <label class='control-label col-md-2 col-md-offset-2' for='id_email' style="text-align:left;"></label>
                <div class='col-md-3'>Landline<input class='form-control' id='landline' name="landline" type='text' value=<?php echo $landline; ?>>
                </div>
