...
<div class="container"  style="padding:30px;width:1500px" >
            	...
            	<div style="border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-4 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;
					 ...
					 <a href="SendSMS_toAll_department_teacher.php?dept=<?php echo $department;?>&batch_id=<?php echo $batch_id;?>&school_id=<?php echo $School_id;?>&status=<?php echo $Sms_status;?>&country=<?php echo $country;?>"> <img src="images/Sms.png"></a>
					 <a href="SendEmail_toAll_department_teacher.php?dept=<?php echo $department;?>&batch_id=<?php echo $batch_id;?>&school_id=<?php echo $School_id;?>&status=<?php echo $Sms_status;?>"> <img src="images/Email.png"></a> 					 <!--  <input type="submit" class="btn btn-primary" name="submit" value="Add Teacher" style="width:150;font-weight:bold;font-size:14px;"/></a>-->
               			 </div>
				...
				<?php $sql1=mysql_query("Select DISTINCT(t_dept) as t_dept,school_id,send_unsend_status,t_country from tbl_teacher where school_id='$sc_id' group by t_dept" );?>
				  <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu2">
				 <?php while($row=mysql_fetch_array($sql1)){ ?>
					
					
					<li role="presentation"><a role="menuitem" tabindex="-1" href="SendMSG_department_Teacher.php?dept=<?php echo $row['t_dept'];?>&school_id=<?php echo $row['school_id'];?>&status=<?php echo $row['send_unsend_status'];?>&country=<?php echo $row['t_country'];?>"><?php echo $row['t_dept'];?><?php }?> </a></li>
               ...
               <?php $i=0;?>
                  <table class="table-bordered  table-condensed cf" id="example" width="100%;" >
                     <thead>
                    	<tr style="background-color:#428BCA" ><th style="width:10%;" ><b>Sr.No</b></th><th style="width:20%;"><b>Teacher ID</b></th><th style="width:20%;" >First Name</th><th style="width:30%;" >Last Name</th><th style="width:20%;">Phone No.</th><th style="width:20%;">Email ID</th> </th><th style="width:10%;">Department</th> </th><th style="width:10%;">Message Status</th> </th><th style="width:20%;">Send SMS/Email</th> </th>
                      
                        </tr></thead><tbody>
                 <?php
				 
				   $i=1;
				  $arr=mysql_query("select * from tbl_teacher where school_id='$School_id' and error_records like 'Correct' and t_dept like '$dept' order by id");?>
				  ...
				  ?>
                    ...
                    <td data-title="First Name" style="width:12%;"><?php echo $row['t_name']?></td> 
                 
					<td data-title="Last Name" style="width:12%;"><?php echo $row['t_lastname']?></td> 
				      ...
				      <td data-title="Batch Id" style="width:6%;"><?php echo $row['t_dept'];?> </td>
					   <td data-title="Send/Unsen Status" style="width:5%;"><?php echo $row['send_unsend_status'];?> </td>
					    <td data-title="Phone" style="width:10%;"><a href="SendSMS_Teacher.php?phone=<?php echo $row['t_phone'];?>&school_id=<?php echo $row['school_id'];?>&status=<?php echo $row['send_unsend_status'];?>&country=<?php echo $row['t_country'];?>"><img src="images/S.png"></a>
						 <a href="SendEmail_Teacher.php?email=<?php echo $row['t_email'];?>&school_id=<?php echo $row['school_id'];?>&status=<?php echo $row['send_unsend_status'];?>"><img src="images/E.png"></a>
						 </td>
