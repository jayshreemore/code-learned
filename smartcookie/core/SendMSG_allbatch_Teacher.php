...
<div class="container"  style="padding:30px;width:1500px" >
            	...
            	<div style="border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-4 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;
					 ...
					 <a href="SendSMS_toAll_batch_teacher.php?batch_id=<?php echo $batch_id;?>&school_id=<?php echo $School_id;?>&status=<?php echo $Sms_status;?>&country=<?php echo $country;?>"> <img src="Images/Sms.png"></a>
					 <a href="SendEmail_toAll_batch_teacher.php?batch_id=<?php echo $batch_id;?>&school_id=<?php echo $School_id;?>&status=<?php echo $Sms_status;?>"> <img src="Images/Email.png"></a> 					 <!--  <input type="submit" class="btn btn-primary" name="submit" value="Add Teacher" style="width:150;font-weight:bold;font-size:14px;"/></a>-->
               			 </div>
				...
				Batch ID's
				  ...
				  <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu2" style="margin-left: 490px;>
               ...
               <?php $i=0;?>
                 ...
                 <?php
				   ...
				   $i=1;
				  $arr=mysql_query("select id,t_id,t_complete_name,t_phone,t_email,t_internal_email,batch_id,send_unsend_status,email_status,t_country,school_id from tbl_teacher where school_id='$School_id' and t_emp_type_pid in ('133','134') and error_records like 'Correct' and batch_id like '$batch_id' order by id");?>
