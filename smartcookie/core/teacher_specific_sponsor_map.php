...
<head>
	...
	<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></script>	<!-- Google Maps API -->
	  <!--<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDRdjaH-2gkRdbcH8i6i9LwUQq1-3S4l_c&callback=initMap"
  type="text/javascript"></script>-->
	...
	function Init()
	{
		...
		var latlng = new google.maps.LatLng( 18.516726,73.856255);	// india, DC
