<?php
include("../version2/smartcookiefunction.php");
 include("../version2/conn.php");
...
<script src="../version2/js/jquery-1.11.1.min.js"></script>
<script src="../version2/js/accordian.js"></script>
...
<body>
 <?php  include("../version2/header.php"); ?>
  ...
  <div class="col-md-12">
      ...
      <div  class="col-md-12" style="border:1px solid #CCCCCC; background-color:#FFFFFF; padding-top:5px;">
        	<div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; background-color:#FFFFFF;">
                    <div style="padding:2px 2px 2px 2px; background-image:url(../version2/image/images_.jpg); color:#FFFFFF; ">
                    Profile
                    </div></div>
...
<p style="font-size:24px; color:#0080FF;">
                			<?php if(  $value['t_pc']==""){?><img id="imgprvw" name="img" src='../version2/image/avatar_2x.png' width="120" height="100" class="preview" /><?php }else{ ?><img src='<?php echo $value['../version2/t_pc'] ?>' width="120" height="120" class="preview" /><?php }?></p>
                <p style="size:18px; padding-bottom::15px; margin-bottom:18px; border-bottom:2px solid #ccc;"><a href="../version2/update_teacher_profile.php?id=1">Edit</a></p>
                    </td>
                    </tr>
	...
	if(datepicker=="")
			{
				...
				document.getElementById('erroredate').innerHTML='Please Enter date';
...
function myFunction1()
	...
	document.getElementById("EmployeeID").innerHTML='<input type="text" size="27" id="EmployeeID" name="EmployeeID" value="<?php echo $value['t_emp_type_pid']; ?>" disabled="disabled" />';
...
<div id="errorpoints1" class="col-md-4"><input type="button" class="btn btn-primary pull-right text-center" onclick="myFunction2()" value="Edit"></div>
  ...
  <!---------------------------------------------------------------------Contact Details------------------------------------------------------------------------------------->
   ...
   <thead>
      <tr>
         <th>Password</th>
         <th id="Pss"><input type="password" size="27" style="background-color:#CCCCCC; border:none;" id="Pss" name="Pss" value="<?php echo $value['t_password'];?>" disabled="disabled" /><span class="glyphicon glyphicon-eye-open" onmouseover="mouseoverPass();" onmouseout="mouseoutPass();"></span></th>
      </tr>
   </thead>
