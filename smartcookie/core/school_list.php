...
if(isset($_POST['search']))
{
	...
	echo $sql="SELECT school_id,school_name,name,reg_date,school_balance_point ,school_assigned_point,balance_blue_points FROM tbl_school_admin where school_id!=''  and reg_date between '$from_date' and '$to_date' order by school_id desc";
	die;
...
<td  data-title="School Name"><?php echo ucwords($result['school_name']);?></td>
<td  data-title="School Head"><?php echo ucwords($result['name']);?></td>
<?php
...
<?php
$sql1="SELECT COUNT('id') as no_teacher  FROM tbl_teacher  where  t_emp_type_pid in (134,133) and school_id='$school_id'";
...
<td  data-title="School assigned Points"><?php echo $result['balance_blue_points'];?></td>
