    ...
    <table id="example" class="display" width="100%" cellspacing="0">
        ...
        <tbody>
			...
			<tr class="active" >
                 ...
                 <td >
                     <a href='studentinformation.php?id=<?php echo $rows['std_PRN'];?>' style="color: black;text-decoration: underline;cursor: auto;"><?php echo $rows['std_PRN']; ?></a>
                 </td>
                 <td>
                     <a href='studentinformation.php?id=<?php echo $rows['std_PRN'];?>' style="color: black;text-decoration: underline;cursor: auto;"><?php echo $rows['std_complete_name']; ?></a>
                 </td>
                 <td>
                     <a href='studentinformation.php?id=<?php echo $rows['std_PRN'];?>' style="color: black;text-decoration: underline;cursor: auto;"><?php echo $rows['std_email']; ?></a>
                 </td>
                 <!--<td>
                 ...
                 <td >
                     <a href='studentinformation.php?id=<?php echo $rows['std_PRN'];?>' style="color: black;text-decoration: underline;cursor: auto;"><?php echo $rows['std_phone']; ?></a>
                 </td>
                 <!--<td>
                 ...
                 <td>
                     <a onClick="confirmation(<?php echo $rows['id']; ?>)">Delete </a>
                 </td>
             </tr>
