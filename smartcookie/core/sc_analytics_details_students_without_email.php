...
$result = mysql_query("SELECT * FROM tbl_student where std_email='' AND school_id = '$school_id'");
?>
<html>
<head>
<style>
...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-heading" align='center'><h3> Students Without Email</h3></div>
