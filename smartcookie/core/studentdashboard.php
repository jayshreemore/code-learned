		...
		$report="";
					...
					if($sc_total_point>=$cp_point)
					{
					  ...
					  //reduce student point after generate coupon
						...
						header("Location:studentdashboard.php?report=".$report);
...
window.location = "teacherthanqpoints1.php?t_id="+t_id;
}
...
<div class="row" align="center">
  <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://smartcookie.bpsi.us" data-text="My reward point is  <?php echo $row_points['sc_total_point'];?>" data-size="large" data-hashtags="smartcookieprogram">Tweet</a>
...
WHERE student_id = '$std_PRN' AND sm.school_id = '$school_id' AND Enable = '1' AND a.school_id = '$school_id' order by subjectName ";
            ...
            <td style="padding-top:9%;">  <?php echo $i;?></td>
...
?>
<td><?php if($test['t_pc'] != ''){?>
                <img src="<?php echo $test['t_pc'];?>" class="preview" style=" width:50px;height:50px;" alt="Responsive image" />
                <?php }else {?> <img src="image/avatar_2x.png"  style="border:1px solid #CCCCCC; width:50px;height:50px;" class="preview" alt="Responsive image"/> <?php }?></td>
...
<td style="margin-top:9%;"> <a class="txt-button" ><input type="button" value="Assign" onClick="openwindow(<?php echo $row['teacher_id']?>);" class="btn btn-primary btn-xs"></a></td>
