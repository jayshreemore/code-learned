...
//	{
		...
		//$rows=  mysql_query("update semester set semester='$semester_new' where id=$semester_id");
	 
		//if(mysql_affected_rows()>0)
		//{
		//	$successreport="Semester is successfully updated !!!";
		//	header("Location:editsemester.php?successreport=".$successreport);
	...
	//	else
		//{
			...
			//$errorreport="semester ".$semester_new." is already present.";
		//}
        ...
        <div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
			...
			<div style="background-color:#F8F8F8;">
                ...
                <div class="col-md-4"></div>
              	<div class="col-md-5 " align="center" style="color:black;padding:5px;" ><h2>Edit Semester</h2></div>
                </div>
...
<div class="col-md-3" style="color:#808080; font-size:18px;">Semester Name</div>
<div class="col-md-3">
...
<div class="row" style="padding-top:10px;">
<div class="col-md-4"></div>
<div class="col-md-3" style="color:#808080; font-size:18px;">Branch Name</div>
<div class="col-md-3">
...
<div class="row" style="padding-top:10px;">
<div class="col-md-4"></div>
<div class="col-md-3" style="color:#808080; font-size:18px;">Course level</div>
<div class="col-md-3">
...
<div class="col-md-4"></div>
<div class="col-md-3" style="color:#808080; font-size:18px;">Is_regular_semester</div>
<div class="col-md-3">
...
<div class="col-md-4"></div>
<div class="col-md-3" style="color:#808080; font-size:18px;">Semester credit</div>
<div class="col-md-3">
...
<div class="col-md-2"><a href="edit.php"><input name="submit" value="Save" class="btn btn-success" type="submit" onClick="return validation()"></div>
