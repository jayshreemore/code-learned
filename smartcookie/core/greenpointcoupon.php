...
<h2 align="center">Green Points Coupon Log</h2>
...
<div id="no-more-tables" style="padding-top:20px;">
  ...
  <table id="example" class="table-bordered table-striped " style="border-collapse:collapse" >
             ...
             <?php $i=1;
			 	...
			 	$sql=mysql_query("SELECT * FROM tbl_giftof_rewardpoint  where user_id='$parent_id' and entity='106' order by id desc ");
...
<td data-title="Amount"><?php echo $result['point'];?></td>
