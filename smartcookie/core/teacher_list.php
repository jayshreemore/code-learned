...
include("cookieadminheader.php");
	...
	$sql="SELECT t_name,t_complete_name,t_middlename,t_lastname,school_id,t_current_school_name,t_email,t_phone,t_address from tbl_teacher where school_id!='' and t_emp_type_pid in (133,134) order by school_id";
	$row=mysql_query($sql);
...
<title><?php echo $dynamic_teacher;?> Information</title>
...
<div class="row" style="padding-top:50px;height:30px;" align="center">
        	...
        	<h2 style="margin-top:2px;color:#666;background-color:#694489;color:white;padding-top:10px;padding-bottom:10px;"> List of Teachers</h2>
...
<div class="row" id="no-more-tables"  style="padding-top:80px;">
