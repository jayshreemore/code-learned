...
if($check == "Yes"){
$query2="select t_email,school_id,t_country,t_phone,t_password,t_current_school_name,send_unsend_status,email_status from `tbl_teacher` where t_dept ='$dept' and school_id='$School_id' order by id desc";
}
else{
$query2="select t_email,school_id,t_country,t_phone,t_password,t_current_school_name,send_unsend_status,email_status from `tbl_teacher` where t_dept ='$dept' and school_id='$School_id' AND email_status = 'Unsend'";	
}
