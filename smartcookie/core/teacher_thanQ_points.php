...
<div style="padding-top:50px;">
        	...
        	<h2 style="padding-left:20px; margin-top:2px;color:#666"> <?php echo $dynamic_school." ".$dynamic_teacher;?></h2>
  ...
  <table id="example" class=" "  align="center">
        		...
        		<thead>
                   ...
                   <th width="15%" align="center"><center><?php echo $dynamic_teacher;?> ID</center></th>
                    <th width="20%" align="left"><?php echo $dynamic_teacher;?> Name</th>
