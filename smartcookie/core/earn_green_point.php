...
<body style="text-shadow: none;">
     ...
     <div class="container">
        ...
        <div  style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; background-color:#FFFFFF;">
                   ...
                   <div style=" padding:15px;">
                     <div class="row" style="padding-top:2px;">
                       ...
                       <div class="col-md-2"></div>
                                   ...
                                   <h3 align="center"> Received Green Points From School Admin </h3>
			...
			$query1=mysql_query("select t.t_complete_name,sp.reason,sp.sc_point,sp.point_date from tbl_teacher_point as sp join tbl_teacher as t on sp.sc_teacher_id=t.t_id where sp.sc_teacher_id='$t_id' and sp.sc_entities_id='102'order by sp.id DESC");	
			
			//echo "select t.t_complete_name,sp.reason,sp.sc_point,sp.point_date from tbl_teacher_point as sp join tbl_teacher as t on sp.sc_teacher_id=t.t_id where  sp.sc_thanqupointlist_id=0 and sp.sc_teacher_id='$t_id' and sp.sc_entities_id='102'";
						   ...
						   $j++;
							...
							?>
                         <tr><td><?php echo $j;?>
                         <td style="padding-left:10px;">School admin share to<?php echo $name ;?></td>
...
<center> <h2>Total</h2> <button type="button" class="btn btn-success"> <span class="badge"><?php echo $sum;?></span></button></center>
