    ...
    <div style="bgcolor:#CCCCCC">
        ...
        <div class="container" style="padding:25px;">
            ...
            <div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                ...
                <div class="col-sm-4" style="color: red;"><?php echo $_GET['deletemessage'];?></div>
                        ...
                        <div class="col-md-12">
                            <div align="right">
                                <table id="example" class="display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    <?php $arr = mysql_query("SELECT *  FROM tbl_studentpointslist sp JOIN tbl_activity_type a WHERE sp.school_id= '$sc_id'  AND a.id = sc_type ORDER BY sc_id");
                                    while ($row = mysql_fetch_array($arr)) {
                                        $i++;
                                        ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['activity_type']; ?></td>
                                            <td>
                                                <a href="editcompanyactivity.php?activity=<?php echo $row['sc_id']; ?>">Edit</a>
                                            </td>
                                            <td><a onclick="confirmation(<?php echo $row['sc_id']; ?> )">Delete</a></td>
                                        </tr>
                                        <?php
