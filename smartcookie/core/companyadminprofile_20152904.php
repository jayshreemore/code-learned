...
$sql=mysql_query("update tbl_school_admin set name='$name',scadmin_gender='$gender',education='$education',scadmin_dob='$id_checkin',address='$address',email='$email',mobile='$mobile',
scadmin_age='$age' where id = ".$_SESSION['id'] );
...
<script type="text/javascript" src="js/jquery.form.js"></script><script type="text/javascript">// < ![CDATA[
...
<img src="<?php echo $result['img_path'];?>"  class='preview' style="height:100px;width:100px;"/>
<?php }?>
</div>
...
<div class="col-md-4"><div class="h" align="center"><h3>Edit Profile</h3></div></div>
...
<form method="post">
<div class="row"><div class="col-md-5" align="center"></div> <div style="color:#FF0000;"><?php echo $report;?></div>
<div style="color:#090;"><?php echo $successreport;?></div></div>
...
<div class="row">
<div class="col-md-5" style="font-size:18px; padding-left:15px;">Name</div><div class="col-md-6"><input type="text" name="name" id="name" class="form-control" value="<?=  $result['name'];?>"></div>

</div>
<div class="col-md-5"></div><div class="col-md-5" id='errorname' style="color:#FF0000;"></div>
...
<input type="radio" name="gender" id="gender1" value="Male"> Male</div>
<div class="col-md-2"><input type="radio" name="gender" id="gender2" value="Female">
 ...
 if($result['scadmin_gender']=="Male"){?>
  <input type="radio" name="gender" id="gender1" value="Male" checked> Male</div>
<?php }else{?>
<input type="radio" name="gender" id="gender1" value="Male"> Male</div>
<div class="col-md-2">
<?php }if($result['scadmin_gender']=="Female"){?>
<input type="radio" name="gender" id="gender2" value="Female" checked>Female</div>
<?php }else{?>
...
<div class="col-md-5"></div><div class="col-md-5" id='errorgender' style="color:#FF0000;"></div>

<div class="row" style="padding-top:20px;">
<div class="col-md-5" style="font-size:18px;">Qualification</div><div class="col-md-6">
...
<div class="col-md-5"></div><div class="col-md-5" id='erroreducation' style="color:#FF0000;"></div>


<div class="row" style="padding-top:25px;">
<div class="col-md-5" style="font-size:18px;">Date of Birth</div><div class="col-md-6"> <input class='form-control datepicker' id='id_checkin' name="id_checkin" value="<?php echo $result['scadmin_dob']?>"></div>
</div>

<div class="col-md-5"></div><div class="col-md-5" id='errordate' style="color:#FF0000;"></div>


<div class="row" style="padding-top:25px;">
<div class="col-md-5" style="font-size:18px;">Organization Name</div><div class="col-md-6"><input type="text" name="school_name" id="school_name" class="form-control" value="<?php echo $result['school_name'];?>" readonly></div>
</div>

<div class="row" style="padding-top:25px;">
<div class="col-md-5" style="font-size:18px;">Organization Address</div><div class="col-md-6"> <textarea class='form-control' id='address' name="address" rows='3'><?php echo $result['address'];?> </textarea></div>
</div>
<div class="col-md-5"></div><div class="col-md-5" id='erroraddress' style="color:#FF0000;"></div>


<div class="row" style="padding-top:25px;">
<div class="col-md-5" style="font-size:18px;">Email</div><div class="col-md-6"><input type="text" name="email" id="email" class="form-control" value="<?php echo $result['email'];?>"></div>
</div>

<div class="col-md-5"></div><div class="col-md-5" id='erroremail' style="color:#FF0000;"></div>

<!--<div class="col-md-6"><input type="password" name="password" id="password" class="form-control" value="<?php echo $result['password'];?>"></div>
</div>

<div class="col-md-5"></div><div class="col-md-5" id='errorpassword' style="color:#FF0000;"></div>


<div class="row" style="padding-top:25px;">
<div class="col-md-5" style="font-size:18px;">Confirm Password</div><div class="col-md-6"><input type="password" name="cpassword" id="cpassword" class="form-control" value="<?php echo $result['password'];?>"></div>
</div>

<div class="col-md-5"></div><div class="col-md-7" id='errorcpassword' style="color:#FF0000;"></div>-->
...
<div class="col-md-5" style="font-size:18px;padding-left:16px;">Mobile No.</div><div class="col-md-6"> <input type="text" id='mobile' name="mobile" value="<?php echo $result['mobile']?>" class="form-control"></div>
</div>
<div class="col-md-5"></div><div class="col-md-5" id='errormobile' style="color:#FF0000;"></div>

<div class="row" style="padding-top:25px;">
<div class="col-md-5" style="font-size:18px;"><a href="change_password.php?email=<?php echo $result['email']?>">Change Password</a></div>
</div>
<div class="row" style="padding-top:40px;" >
<div class="col-md-3"></div>
<div class="col-md-3"><input type="submit" name="submit" class="btn btn-primary" value="Update" onClick="return valid();"></div>
<div class="col-md-3"><a href="scadmin_dashboard.php" style="text-decoration:none"> <input type="button" class="btn btn-danger" value="Cancel"></a></div>
