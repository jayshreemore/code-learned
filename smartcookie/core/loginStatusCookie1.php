   ...
   <table id="example" class="display" width="100%" cellspacing="0">
        ...
        <tbody>
         ...
         function checkEntity($entity)
         {
          ...
          $sql = "SELECT `EntityID`,`Entity_type`,`LatestLoginTime`,`LogoutTime`,`LatestMethod`,`LatestDeviceDetails`,`LatestPlatformOS`,`LatestIPAddress`,`LatestBrowser` FROM `tbl_LoginStatus` WHERE 1" ;
