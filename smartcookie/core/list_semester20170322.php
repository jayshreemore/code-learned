...
<div class="container" style="padding:25px;" >
               ...
               <?php $i=0;?>
				...
				$arr=mysql_query("select DISTINCT Semester_Id,Department_Name,Semester_Name,Branch_name,Is_enable,Is_regular_semester,Semester_credit,class,batch_id from  tbl_semester_master where school_id='$sc_id'");
				
				if(isset($info)){ 
				if($info =='1'){
				  $arr=mysql_query("select DISTINCT Semester_Id,Department_Name,Semester_Name,Branch_name,Is_enable,Is_regular_semester,Semester_credit,class,batch_id from  tbl_semester_master where school_id='$sc_id' and Is_enable='1'");
				}
				if($info =='2'){
					 $arr=mysql_query("select DISTINCT Semester_Id,Department_Name,Semester_Name,Branch_name,Is_enable,Is_regular_semester,Semester_credit,class,batch_id from  tbl_semester_master where school_id='$sc_id'");
					}
				 ...
				 if($_GET['Branch_name']){
					...
					$arr=mysql_query("select DISTINCT Semester_Id,Department_Name,Semester_Name,Branch_name,Is_enable,Is_regular_semester,Semester_credit,class,batch_id from  tbl_semester_master where school_id='$sc_id' and Branch_name='$branch'");
				} 
				if($_GET['Department_Name']){
					$DepartmentName=$_GET['Department_Name'];
					$arr=mysql_query("select DISTINCT Semester_Id,Department_Name,Semester_Name,Branch_name,Is_enable,Is_regular_semester,Semester_credit,class,batch_id from  tbl_semester_master where school_id='$sc_id' and Department_Name='$DepartmentName'");
				}
				if($_GET['Semester_Name']){
					$SemesterName=$_GET['Semester_Name'];
					$arr=mysql_query("select DISTINCT Semester_Id,Department_Name,Semester_Name,Branch_name,Is_enable,Is_regular_semester,Semester_credit,class,batch_id from  tbl_semester_master where school_id='$sc_id' and Semester_Name='$SemesterName'");
				}
				if($_GET['Is_enable']){
					$Isenable=$_GET['Is_enable'];
					$arr=mysql_query("select DISTINCT Semester_Id,Department_Name,Semester_Name,Branch_name,Is_enable,Is_regular_semester,Semester_credit,class,batch_id from  tbl_semester_master where school_id='$sc_id' and Is_enable='$Isenable'");
				}
				?>
                  <?php while($value=mysql_fetch_array($arr)){?>
