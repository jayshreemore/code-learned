...
<div class='col-lg-12'>
<div class="form-group has-success">
<input class="form-control" type="text" name="Student_PRN" placeholder="Student PRN" value="<?php if(isset($_POST['Roll_no'])) { echo $_POST['Roll_no']; }?>">
</div>
</div>
</td>
<td>
...
else
{
	...
	?>
			...
			<th style="text-align:center">Student PRN</th>
