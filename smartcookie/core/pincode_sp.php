...
$details->city; echo "<br>"  ;  // => Mountain View
$details->country; echo "<br>"  ; 
$details->region; echo "<br>"  ;// => US
$details->org;     echo "<br>"  ; // => AS15169 Google Inc.
$details->hostname; echo "<br>" ;// => google-public-dns-a.google.com

$details->loc;  echo "<br>" ;
$details->ip; echo "<br>" ;
$details->postal; echo "<br>" ;
echo "<br>" ;
