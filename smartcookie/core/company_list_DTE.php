...
<input   class="form-control"  type="text" name="collcode" placeholder="Company Code" value="<?php if(isset($_POST['collcode'])) { echo $_POST['collcode']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
...
<div class=''>
<div class="form-group has-success">
<input   class="form-control"  type="text" name="collname" placeholder="Company Name" value="<?php if(isset($_POST['collname'])) { echo $_POST['collname']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
...
if($collcode=='' & $collname=='' & $stream=='' & $location=='')
	{
		...
		echo "<script>window.location.assign('company_list_DTE.php')</script>";
	}
else
{
	$f = 0;
                                     ...
                                     <td style="padding:10px;" align="center"><?php echo $rows['number_of_teachers'];?></td>
                                        ...
                                        <td style="padding:10px;" align="center"><?php echo $rows['number_of_subjects'];?></td>
                                           <td style="padding:10px;" align="center"><?php echo $rows['date_Updated'];?></td>
                                                ...
                                                <td>	
                        <a href='college_DTE_delete.php?id=<?php echo $rows["id"];?>'><button type="button" class="btn btn-danger btn-sm" style=" border-radius: 25px" >Delete</button></a>
                                                </td>
