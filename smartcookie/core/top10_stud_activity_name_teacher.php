...
/* $school_id=$_GET['id'];
$activity_id=$_GET['sc_id']; */

//$subject_id=$_GET['id'];
$activity_id=$_GET['sc_id'];

$id=$_SESSION['id'];
$query="select * from `tbl_teacher` where id='$id'";       // getting the the school id of login user by checking the session
...
<div class="panel panel-info">
  ...
  <div class="panel-heading text-center">
    <h3 class="panel-title">List of Top 10 Students</h3>
  </div>
...
<div class="dropdown">
  ...
  <ul class="dropdown-menu "  role="menu" aria-labelledby="dropdownMenu1">
   ...
   <?php $sql1=mysql_query("Select school_name from tbl_school order by `school_name` ASC" );?>
	...
	<li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_teacher.php">All School</a></li>
   ...
   <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_school_name_teacher.php?id=<?php echo $row['id'];?>"><?php echo $row['school_name'];?><?php }?></a></li>
...
Duration
  ...
  <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu1">
    ...
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_week_name_teacher.php">Week </a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_month_name_teacher.php">Month</a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_year_name_teacher.php">Year</a></li>
...
Subject/Activity
  ...
  <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu1">
   ...
   <li role="presentation" class="divider"></li>
	...
	<li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_subject_name_teacher.php?id=<?php echo $row['id'];?>"><?php echo $row['subject'];?><?php }?></a></li>
	...
	<li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_activity_name_teacher.php?id=<?php echo $row['school_id'];?>&sc_id=<?php echo $row['sc_id'];?>"><?php echo $row['sc_list'];?><?php }?></a></li>
					...
					<?php 
					$sql=mysql_query("select spl.sc_list,s.std_complete_name,s.std_img_path,s.std_school_name,sum(sc_point) as total from tbl_student s join tbl_student_point sp on s.id=sp.sc_stud_id join tbl_studentpointslist spl on spl.sc_id = sp.sc_studentpointlist_id
