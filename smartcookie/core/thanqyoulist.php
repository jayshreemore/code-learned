...
<div class="container" style="padding:25px;" >
            	...
            	<div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-4"  style="color:#700000 ;padding:5px;" >
                       <a href="addthanqyouschool.php">
                        ...
                        <div class="col-md-1 "></div>
						 ...
						 {
							 ?>
                          <div class="col-md-2 "  style="color:#700000; padding:5px" >
                 ...
                 <a   href = "copy_thanqyou.php?id=<?php echo $sc_id;?>"   >   <input type="button" class="btn btn-primary" name="copy" value="Copy from Cookieadmin" style="width:180;font-weight:bold;font-size:14px;"/></a>
						 ...
						 <div class="col-md-2 "  style="color:#700000; padding:5px" >
                  <!-- grorp admin logic added by jayshree-->
                 <a   href = "copy_thanqyou_from_groupadmin.php?Group_id=<?php echo $group_status;?> & id=<?php echo $sc_id;?> "   >  
				 <input type="button" class="btn btn-primary" name="copy2" value="Copy from Group admin" style="width:180;font-weight:bold;font-size:14px;"/></a>
