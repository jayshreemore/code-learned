...
<div class="container" style="padding:25px;" >
            	...
            	<div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="row">
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <a href="add_school_division.php">   <input type="button" class="btn btn-primary" name="submit" value="Add Division" style="width:110px;font-weight:bold;font-size:14px;"/></a>
               			 </div>
              			 <div class="col-md-5 " align="center"  >
               ...
               <?php $i=0;?>
                 <table id="example" class="display" width="100%" cellspacing="0">
                     <thead>
						...
						<!--<b><center>Division ID</center></b></th><th style="width:;" >
