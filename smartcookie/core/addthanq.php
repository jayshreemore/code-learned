				...
				for($i=0;$i<$count;$i++)
				          {
							  ...
							  //check already class exist or not
								 if(mysql_num_rows($results)==0 && $activity!="")
									{
										$query="insert into tbl_thanqyoupointslist(t_list,school_id) values('$activity','0') ";
               ...
               <div class="col-md-3" id="E-0" style="color:#FF0000;">
                ...
                <div id="add">
                  ...
                  <div class="col-md-2 col-md-offset-2 "  >
                    ...
                    <a href="thanqyou.php" style="text-decoration:none;"><input type="button" class="btn btn-primary" name="Back" value="Back" style="width:80px;font-weight:bold;font-size:14px;" /></a>
                    </div>
