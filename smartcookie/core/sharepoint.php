...
window.location = "share.php?stud_id="+stud_id;
}
...
<div class="container" style="padding-top:5px;">
            ...
            <h4 align="center"> Share Points</h4>
            </div>        
...
<ul class="nav nav-tabs" style="padding-top:10px;">
    <li class="active"><a data-toggle="tab" href="#home">Share Points</a></li>
    <li><a data-toggle="tab" href="#menu1">Share Points Log</a></li>
  ...
  <div class="tab-content">
                ...
                <tbody>
                    ...
                    $i=0;
                        ...
                        <tr>
							...
							{
						 echo ucwords(strtolower($row1['std_name']." ".$row1['std_Father_name']." ".$row1['std_lastname']));
							}
							?></td>
                            ...
                            <a class="txt-button" onClick="openwindow(<?php echo $stud_id;?>);"><input type="button" value="Share" class="btn btn-primary"></a>
    ...
    <div id="menu1" class="tab-pane fade">
      ...
      <div id="no-more-tables" style="padding-top:20px;">
                ...
                <tbody>
                    <?php  $sql1="select s.std_PRN,s.std_name,s.std_complete_name,sp.sc_point,sp.reason,sp.point_date,sp.type_points from tbl_student_point sp join tbl_student s where sp.sc_stud_id=s.std_PRN and sp.sc_entites_id='105' and sp.sc_teacher_id='$std_PRN' order by sp.id desc";
                    $i=0;
                        $arr1 = mysql_query($sql1);
                        while($row1 = mysql_fetch_array($arr1))
                        {
