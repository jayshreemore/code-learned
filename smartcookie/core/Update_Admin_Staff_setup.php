     ...
     <div class='row' align="center"  style="color:#090"><?php echo $report;?></div>
      ...
      <div class='panel-body'>
        ...
        <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_title' style="text-align:left;">Staff Name<span class="error"> *</span></label>
             ...
             <div class='col-md-8'>
              ...
              <div class='col-md-4 indent-small' id="errorname" style="color:#FF0000">
						   ...
						   ?>     
        <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_checkin' style="text-align:left;">Education<span class="error"> *</span></label>
            <div class='col-md-8'>
              <div class='col-md-5'>
        ...
        <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_checkin' style="text-align:left;">Designation<span class="error"> *</span></label>
            <div class='col-md-8'>
              <div class='col-md-5'>
                <div class='form-group internal input-group'>
        ...
        -->
            ...
            <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_checkin' style="text-align:left;">Date Of Birth<span class="error"> *</span></label>
            <div class='col-md-8'>
              <div class='col-md-5'>
                <div class='form-group internal input-group'>
