...
<script>
    ...
    function confirmSMS(phone,school_id,Status,country) {
        if(Status=='Send_SMS'){
            ...
            if (answer) {
                window.location = "Send_SMS_School_admin.php?phone="+phone+"&school_id="+school_id+"&Status="+Status+"&country="+country;
            }
            else {
            }
        }else{
                ...
                <div class="row" style="padding:10px;">
                    <div class="col-md-12  " id="no-more-tables">
                        ...
                        <table class="table-bordered  table-condensed cf" style="border: 1px solid #ccc;" id="example" width="100%;">
                            ...
                            <?php
                            $i = 1;
                            $arr = mysql_query("select * from tbl_school_admin order by id"); ?>
