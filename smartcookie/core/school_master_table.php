    ...
    <div class="container"
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <table id="no-more-tables" class=" table-bordered table-striped table-condensed cf" width="100%"
                       style="padding:5px;">
                    <thead class="cf">
                ...
                <div class="col-md-7" style="padding-left:0px;">
                    ...
                    <div class="row" style="margin-bottom:10px;">
                        ...
                        <div class="col-md-3" style="padding-left:0px;">
                            <a href="subject_pointmethod.php" style="text-decoration:none;"><input type="button"
                                                                                                   class="btn btn-primary"
                                                                                                   value="Add <?php echo $dynamic_subject;?> Method"
                                                                                                   style=""/></a>

                        </div>
                        <div class="col-md-3 col-md-offset-3">
                            <a href="activity_pointmethod.php" style="text-decoration:none;"><input type="button"
                                                                                                    class="btn btn-primary"
                                                                                                    value="Add Activity Method"
                                                                                                    style=""/></a>
