...
?>
 ...
 <?php
		...
		$school_balance_point=$arr['school_balance_point'];
			...
			{       
					$date=date('d/m/Y');
                    $log=mysql_query("INSERT into tbl_teacher_point(`sc_teacher_id`,`sc_entities_id`,`sc_point`,`point_date`,`reason`,`school_id`,`assigner_id`)
							   VALUES('$teacher_id','102','$point','$date','assigned by school admin','$school_id','$school_id')");
...
<div style="background-color:#FFFFFF; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;" align="left">
		...
		?>  </center></h2>
         ...
         <?php 
            ...
            $sql=mysql_query("select id,t_complete_name,t_name,t_middlename,t_lastname,school_id,t_current_school_name,tc_balance_point from tbl_teacher where t_id='$teacher_id' and school_id='$school_id'");
...
<div class="row" style="padding-top:30px" align="center"><input type="submit" name="submit" value="Assign" class="btn btn-primary" onClick="return valid();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="teacherassign.php" style="text-decoration:none;"><input type="button" value="Back" class="btn btn-danger"></a></div>
