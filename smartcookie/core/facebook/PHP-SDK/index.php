        ...
        <script type="text/javascript">
            function streamPublish(name, description, hrefTitle, hrefLink, userPrompt){        
                FB.ui({ method : 'feed', 
                        ...
                        link   :  hrefLink,
                        caption:  hrefTitle,
                        picture: 'http://panhealth.in/wp-content/uploads/2014/04/panhealthlogo.png'
               });
               //http://developers.facebook.com/docs/reference/dialogs/feed/
   
            }
            function publishStream(){
                streamPublish("Stream Publish", 'Register on Smart Cookies. I found some of them are just awesome!', 'Smart Cookies', 'http://panhealth.com', "Reward system");
            }
            
            function newInvite(){
                 var receiverUserIds = FB.ui({ 
                        method : 'apprequests',
                        message: 'Come on man checkout my applications. visit http://panhealth.com',
                 },
...
<div id="fb-root"></div>
    ...
    <a href="http://panhealth.com" target="_blank" style="text-decoration: none;">
       <img src="http://panhealth.in/wp-content/uploads/2014/04/panhealthlogo.png" style="border:none" alt="Smart Cookies" height="92" />
   </a>
   <br />
    <h3>Smart Cookies</h3>
    ...
    <?php if (!$user) { ?>
        ...
        <a class='login' href='<?=$loginUrl?>'><img src='images/login-button.png' /></a>
    <?php } else { ?>
        ...
        <tr>
            <td>
                <div class="box">
                    ...
                    <br /><br />
                    <a href="<?=$fbconfig['../PHP-SDK-3.0---Graph-API-base-Facebook-Connect-Tutorial-Source-master/baseurl']?>?publish=1">Publish Post using PHP </a>
                    <br />
    ...
    <div class="box">
        <form name="" action="<?=$fbconfig['../PHP-SDK-3.0---Graph-API-base-Facebook-Connect-Tutorial-Source-master/baseurl']?>" method="post">
