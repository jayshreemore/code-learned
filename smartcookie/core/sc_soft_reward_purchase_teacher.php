...
$row=mysql_query("SELECT p.user_id,p.school_id ,s.rewardType FROM purcheseSoftreward as p inner join softreward as s on p.reward_id=s.softrewardId where userType='Teacher' AND school_id = '$school_id'");
...
<body>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" align='center'><h3> soft reward purchased by teacher</h3></div>
	...
	<tbody>
	 ...
	 $i = 1;
       ...
       while ($result= mysql_fetch_array($row)){
		...
		$q=mysql_query("select t_complete_name from tbl_teacher where id='$id'");
