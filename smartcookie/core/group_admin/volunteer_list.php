...
$sql = "SELECT t_name,t_complete_name,t_middlename,t_lastname,school_id,t_current_school_name,t_email,t_phone,t_address from tbl_teacher where group_status='$group_name' order by school_id";
$row = mysql_query($sql);
?>
<!DOCTYPE>
<html>
<head>
    ...
    <script src="<?php echo "http://".$server_name.'/code.jquery.com/ui/1.11.2/jquery-ui.js';?>"></script>
    <script>
...
<div class="container" style="width:100%;">
    <div class="row" style="padding-top:50px;height:30px;" align="center">
        <h2 style="margin-top:2px;color:#666"> List of Volunteer</h2>
    </div>
