...
<div class="container" style="padding:25px;">
            	...
            	<div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <a href="add_company_designation.php?id=<?=$staff_id?>">   <input type="button" class="btn btn-primary" name="submit" value="Add Designation" style="width:135px;font-weight:bold;font-size:14px;"/></a>
				  ...
				  ?> 
                 		<tr style="height:30px;color:#808080;">
                            ...
                            <th style="width:150px;" ><center><?php $id=$row1['id'];?>
                            	<a href="edit_school_division.php?divi=<?php echo $id; ?> " style="">Edit</a></center> 
							</th>
...
<div class="container" style="padding:25px;" >
            	...
            	<div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="row">
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <a href="add_company_designation.php">   <input type="button" class="btn btn-primary" name="submit" value="Add Designation" style="width:135px;font-weight:bold;font-size:14px;"/></a>
               			 </div>
              			 <div class="col-md-5 " align="center"  >
