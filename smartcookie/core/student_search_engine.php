...
<div class=''>
<div class="form-group has-success">
<input   class="form-control"  type="text" name="std_PRN" placeholder="std_PRN" value="<?php if(isset($_POST['std_PRN'])) { echo $_POST['std_PRN']; }?>">
</div>
</div>
</td>
...
<input  class="form-control"  type="text" name="std_dept" placeholder="std_dept" value="<?php if(isset($_POST['std_dept'])) { echo $_POST['std_dept']; }?>">
</div>
</div>
</td>
...
<div class=''>
<div class="form-group has-success">
<input  class="form-control"  type="text" name="std_email" placeholder="std_email" value="<?php if(isset($_POST['std_email'])) { echo $_POST['std_email']; }?>">
</div>
</div>
</td>
</tr>
...
<div class=''>
<div class="form-group has-success">
<input  class="form-control"  type="text" name="std_phone" placeholder="std_phone" value="<?php if(isset($_POST['std_phone'])) { echo $_POST['std_phone']; }?>">
</div>
</div>
</td>
<?php
...
<option value="<?php if(isset($_POST['Academic_Year'])) { echo $_POST['Academic_Year']; }?>"><?php if(isset($_POST['Academic_Year'])) { echo $_POST['Academic_Year']; } else {echo 'select option';}?></option>
...
<div class=''>
<div class="form-group has-success">
<input  class="form-control"  type="text" name="Course_level" placeholder="Course_level" value="<?php if(isset($_POST['Course_level'])) { echo $_POST['Course_level']; }?>">
</div>
</div>
</td>
	...
	if(mysql_num_rows($sql)>0)
		{
			...
			<th style="text-align:center">std_PRN</th>
			<th style="text-align:center">std_dept</th>
			
			
			<th style="text-align:center">std_email</th>
			<th style="text-align:center">std_phone</th>
			<th style="text-align:center">Academic_Year</th>
			<th style="text-align:center">Course_level</th></tr>
              </thead>
            <tbody>
