...
<div class="container" style="padding:10px;">
    ...
    <div class="col-md-8 "  align="left">
                    ...
                    <h1 style="padding-left:5px; margin-top:5px;">List of Activity </h1>
         </div>
        ...
        <div id="no-more-tables" style="padding-top:20px;">
                ...
                <tbody>
                     <?php  $sql="select sc_list,activity_type,stp.sc_id from tbl_studentpointslist stp join tbl_activity_type  act on stp.sc_type=act.id  where stp.school_id='0' ORDER BY  sc_id DESC";
                    ...
                    $i=0;
                        ...
                        <tr>
                            ...
                            <td data-title="Activity" width="45%"><?php echo $row1['sc_list'];?></td>
                            <td data-title="points" width="20%" ><?php echo $row1['activity_type'];?></td>
                            <td data-title="Edit" width="10%" align="center"> <a href="edit_system_Activity.php?activity=<?php echo $row1['sc_id'];  ?>"   style="text-decoration:none">Edit</a></td>
                            <td data-title="Delete" width="10%" align="center"><a style="text-decoration:none" onClick="confirmation(<?php echo $row1['sc_id']; ?> )">Delete</a></td>
