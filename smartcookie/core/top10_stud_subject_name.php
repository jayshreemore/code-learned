...
$id=$_SESSION['id'];
$query="select * from tbl_student where id='$id'";       // getting the  school id of login user by checking the session
$row1=mysql_query($query);
$value1=mysql_fetch_array($row1);
 $school_id=$value1['school_id'];


/* $query2="select id from `tbl_school_subject` where subject='$subject_name'";
				  ...
				  <div class='container-fluid'>
					...
					<thead align="center">
						<tr class="warning" >
							...
							<th align="center"><?php echo $dynamic_subject;?> Name</th>
