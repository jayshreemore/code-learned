...
<div class="container-fluid" align="center" >
 <div class="row">
 <div class="col-md-2" style="float:left; padding:10px;padding-left:20px; font-size:21px; font-weight:bold;"><img src="images/logo.png" class="img-responsive">
                </div>
            ...
            <!--<div class=" navbar-inverse" role="navigation" style="background-color:#0073BD;width:100%;">
                   ...
                   <li><a class="dropdown-toggle" data-toggle="dropdown"  href="#">Log</a>
                             <ul class="dropdown-menu">
                                 ...
                                 <li><a href="softrewardlog1.php">Soft Reward</a></li>
                                  <li><a href="loginStatusCookie1.php">Login Status</a></li>
             ...
             <?php
                                    ...
                                    if($lb!==false || $flag){ ?>
					 <li><a href="Error_log_report1_20160207PT.php">Error Log Report</a></li>
              <?php } ?>
