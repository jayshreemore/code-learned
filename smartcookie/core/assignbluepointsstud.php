...
if($_POST['point']>0)
{
      ...
      if(isset($_POST['point']) && isset($_POST['Department']))

			 {
				...
				$updatepoint=mysql_query("UPDATE tbl_student SET balance_bluestud_points = IF(balance_bluestud_points is NULL,'$point', balance_bluestud_points+'$point') WHERE school_id='$school_id' AND std_branch='$Degree'");				
...

		   {
					...
					// updated by Pravin AND Rohit 2017/09/03 1.47AM
...
<h2>Assign blue points to <?php echo $dynamic_student;?></h2>
