...
$row=mysql_query("SELECT tvc.coupon_id, tvc.code, tvc.user_id FROM tbl_selected_vendor_coupons as tvc where tvc.entity_id='3' AND used_flag ='used' AND school_id = '$school_id'");
...
<body>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" align='center'><h3> Vendor coupon used by Student</h3></div>
	...
	<tbody>
	 ...
	 $i = 1;
       ...
       while ($result= mysql_fetch_array($row)){
		...
		$q=mysql_query("select std_complete_name,school_id from tbl_student where id='$id'");
