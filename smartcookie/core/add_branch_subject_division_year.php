...
$sql1 = mysql_query("insert into Branch_Subject_Division_Year(Intruduce_YeqarID,ExtSchoolSubjectId,SubjectTitle,SubjectCode,
SubjectType,SubjectShortName,IsEnable,CourseLevel,CourseLevelPID,DeptID,DeptName,BranchID,BranchName,SemesterID,SemesterName,
DevisionId,DivisionName,ExtYearID,Year)
values('$Intruduce_YeqarID','$ExtSchoolSubjectId','$SubjectTitle','$SubjectCode',
