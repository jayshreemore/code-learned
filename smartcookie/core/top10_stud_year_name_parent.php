...
$id=$_SESSION['id'];
$query="select * from `tbl_parent` where id='$id'";       // getting the the school id of login user by checking the session
  ...
  <ul class="dropdown-menu "  role="menu" aria-labelledby="dropdownMenu1">
   ...
   <?php $sql1=mysql_query("Select school_name from tbl_school order by `school_name` ASC" );?>
    ...
    <li role="presentation" class="dropdown-header">All School</a></li>
	 <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_parent.php">All School</a></li>
    ...
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_school_name_parent.php?id=<?php echo $row['id'];?>"><?php echo $row['school_name'];?><?php }?></a></li>
...
Duration
    ...
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_week_name_parent.php">Week </a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_month_name_parent.php">Month</a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_year_name_parent.php">Year</a></li>
...
Subject/Activity
  ...
  <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu1">
   ...
   <li role="presentation" class="divider"></li>
	...
	<li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_subject_name_parent.php?id=<?php echo $row['id'];?>"><?php echo $row['subject'];?><?php }?></a></li>
	...
	<li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_activity_name_parent.php?id=<?php echo $row['school_id'];?>&sc_id=<?php echo $row['sc_id'];?>"><?php echo $row['sc_list'];?><?php }?></a></li>
					...
					<?php 
					//echo "Select s.std_name,s.std_img_path,s.std_school_name,st.sc_total_point,sp.point_date from  tbl_student_point sp left outer join tbl_student s on sp.sc_stud_id=s.id  left outer join tbl_student_reward st on s.id=st.sc_stud_id j where point_date BETWEEN DATE_SUB(CURDATE() ,INTERVAL 7 DAY) AND CURDATE() order by st.sc_total_point desc limit 10";
					$sql=mysql_query("SELECT ss.std_complete_name, sp.sc_stud_id, std_school_name, ss.std_img_path, sp.point_date, st.sc_total_point FROM tbl_student_point sp
										...
										WHERE point_date
										BETWEEN DATE_FORMAT( (CURDATE( ) - INTERVAL 365 DAY ) , '%m/%d/%Y') AND CURDATE( ) GROUP BY sc_stud_id ORDER BY st.sc_total_point DESC LIMIT 10");
