             ...
             <div class="col-md-12  " id="no-more-tables" >
               ...
               <?php $i=0;?>
                  ...
                  <thead>
                     ...
                     <tr style="background-color:#555;color:#FFFFFF;height:30px;"><th >Sr.No</th><th><b>Teacher ID</b></th><th  >Name</th><th>Phone No.</th>

					 <th style="width:20%;">Landline No.</th><th style="width:20%;">Email ID</th><th style="width:20%;">Internal Email ID</th><th>Department</th><th>Date Of Appointment</th><th style="width:20%;">Gender</th><th style="width:20%;">DOB</th><th style="width:10%;">Emp. Type PID</th><th >Address</th><th  >Green Balance Points</th><th style="width:10%;" >Green Assigned Points </th><th style="width:10%;" >Blue Balance Points</th><th  >Blue Shared Points </th>
                ...
                <tr style="color:#808080;" class="active">
                    ...
                    <td data-title="Name" style="width:20%;"><?php echo $row['t_complete_name']?></td> 

                     

                         <td data-title="Phone" style="width:10%;"><?php echo $row['t_phone'];?> </td>

						  <td data-title="Phone" style="width:10%;"><?php echo $row['t_landline'];?> </td>

						  <td data-title="Phone" style="width:0%;"><?php echo $row['t_email'];?> </td>

						  <td data-title="Phone" style="width:0%;"><?php echo $row['t_internal_email'];?> </td>

						 <td data-title="Department" style="width:10%;"><?php echo $row['t_dept'];?> </td>

						 <td data-title="Department" style="width:10%;"><?php echo $row['t_date_of_appointment'];?> </td>

						 <td data-title="Gender" style="width:10%;"><?php echo $row['t_gender'];?> </td>

						 <td data-title="Gender" style="width:10%;"><?php echo $row['t_dob'];?> </td>

						  <td data-title="Gender" style="width:10%;"><?php echo $row['t_emp_type_pid'];?> </td>

						  <td data-title="Gender" style="width:10%;"><?php echo $row['t_address'];?> </td>
...
<div class="container"  style="padding:30px;" >
            	...
            	<div style="border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <a href="scadmin_dashboard.php">   <input type="submit" class="btn btn-primary" name="submit" value="Back" style="width:150;font-weight:bold;font-size:14px;"/></a>
               ...
               <?php $i=0;?>
                  ...
                  <table class="table-bordered  table-condensed cf" id="example" width="100%;" >
                     ...
                     <tr style="background-color:#555;color:#FFFFFF;height:30px;" ><th >Sr.No</th><th >Profile Image</th><th>Client ID</th><th style="width:385px;" >Name</th><th>Project ID</th><th style="width:385px;" >Project Name</th><th>Project Started Date</th> <th>Project Deliver Date</th><th>Email ID</th><th>Address</th></tr> </thead>
                 ...
                 <?php
				  ...
				  $arr=mysql_query("select * from tbl_teacher where (`t_emp_type_pid`!='133' and `t_emp_type_pid`!='134') and school_id='$sc_id' order by id");?>
                  ...
                  <tr >
                    ...
                    <td data-title="Profile Picture"style="width:10%;"><?php if($row['t_pc']!=""){ ?><img src="<?php echo $row['t_pc'];?>"  class="preview" style=" width:70px;height:70px;" alt="Responsive image" /><?php }else{ ?> <img src="image/avatar_2x.png" style="border:1px solid #CCCCCC; width:70px;height:70px;" class="preview" alt="Responsive image"/><?php } ?></td>
