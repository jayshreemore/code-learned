...
$app_id		= "523355671131002";
$app_secret	= "35c5153fe7dc6893a0cbe2f0d6c46cd7";
$site_url	= "http://www.blueplanetinfosolutions.com/";
...
if($user){
	...
	// Get login URL
	echo $loginUrl = $facebook->getLoginUrl(array(
...
//========= Batch requests over the Facebook Graph API using the PHP-SDK ========
	...
	echo $user_info		= json_decode($batchResponse[0]['body'], TRUE);
