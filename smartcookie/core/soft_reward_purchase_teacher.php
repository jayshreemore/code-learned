...
$row=mysql_query("SELECT p.user_id,p.school_id ,s.rewardType FROM purcheseSoftreward as p inner join softreward as s on p.reward_id=s.softrewardId where userType='Teacher'");
