    ...
    <form class='form-horizontal' role='form' method="POST" action="" onSubmit="return valid()">
        ...
        <div class='form-group'>
            ...
            <div class='col-md-2' style="text-align:left;">
                <input class='form-control' id='std_prn' name="std_prn" type='text' value="<?php echo $std_PRN; ?>">
            </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3' style="text-align:left;">
                <input class='form-control' id='id_email' name="std_email" type='text'
                       value="<?php echo $std_email; ?>">
            </div>
            <div class='col-md-3'>
                <input class='form-control' id='id_phone' name="std_phone" type='text'
                       value="<?php echo $std_phone; ?>">
            </div>
        </div>
        <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_email' style="text-align:left;">Internal Email
                Id</label>
        ...
        <div class='form-group'>
            <div class='col-md-3 col-md-offset-3'>
                <center><input class='btn-lg btn-primary' type='submit' value="Update" name="update"/>
