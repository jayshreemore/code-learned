...
<div class="container-fluid" align="center" >
 <div class="row">
 <div class="col-md-2" style="float:left; padding:20px;padding-left:20px; font-size:21px; font-weight:bold;"><img src="images/logo.png" class="img-responsive">
                </div>
                     ...
                     <li><a class="dropdown-toggle" data-toggle="dropdown"  href="#">Master</a>
                             <ul class="dropdown-menu">
                                 ...
                                 <?php
                                            ...
                                            if($lb!==false || $flag){ ?>
                                 <li><a href="salesperson_list_cookie.php">Sales person</a></li>
                                 <?php } ?>
                                ...
                                <?php } ?>
								 <?php
                                            $lb= strpos($perm,"ThanQ List");
                                            if($lb!==false || $flag){ ?>
                                 <li><a href="student_reason.php">Student Recognization</a></li>
                                <?php } ?>
