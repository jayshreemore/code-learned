...
<div class="container" style="padding:30px;" >
        	...
        	<div style="border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <a href="Add_academic_year.php"> <input type="submit" class="btn btn-primary" name="submit" value="Add Academic Year" style="font-weight:bold;font-size:14px;"/></a>
    ...
    <table id="example" align="center" class="display" style="text-align: center;" width="100%" cellspacing="0">
        ...
        <thead style="text-align: center;">
            ...
            <tr >
                <th style="width:100px; style="text-align: center;"">Sr. No</th>
        ...
        <tbody>
            <?php $sql = "SELECT DISTINCT * FROM  `tbl_academic_Year`  WHERE `school_id`='$sc_id'";
