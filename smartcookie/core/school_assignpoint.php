...
<body>
    ...
    <div >
    	...
    	<div style="height:50px; background-color:#FFFFFF; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;" align="left">
        	<h2 style="padding-left:20px; margin-top:2px;color:#003399">Assign Points to School</h2>
        </div>
...
WHERE school_id =  '$school_id'");
        ...
        <div class="row">
        <div class="col-md-4">
       		<div align="left" style="padding:10px;font-size:16px"> <b>School ID</b></div></div>
			<div class="col-md-4">
			<?php echo $school_id;?>
            </div>
            </div>
          ...
          <div class="row">
          <div class="col-md-4">
              <div align="left" style="padding:10px;font-size:16px"><b> School Head</b></div>
			  </div>
			      <div class="col-md-3">
...
echo $result['school_balance_point'];
 ?></div>
               ...
               <div style="color:#008000;" id="errorpoints" align="center"><?php echo $report;?></div>
