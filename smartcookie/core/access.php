...
//------------------------------End--------------------------------------------------
    ...
    ?>
    <script>
        alert('Permission should not grant successfully');
    </script>
    <?php
}
?>
...
<div class='form-group'>
 ...
 <!-- <td style=" background-color:#B2B2B2;"><input type="checkbox" name="permission[]" value="Star Board"> Star Board&nbsp;</td> --->
  ...
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="Teacher"> Teacher&nbsp;</li>
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="Student"> Student&nbsp;</li>
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="School Master"> School Master&nbsp;</li>
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="Activity"> Activity&nbsp;</li>
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="Subject"> Subject&nbsp;</li>
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="Degrees"> Degrees&nbsp;</li>
  ...
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="Get Teachers Password File"> Get Teachers Password File&nbsp;</li>
  ...
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="Upload Panel"> Upload Panel&nbsp;</li>
       ...
       <li><input type="checkbox" class="subpoint" name="permission[]" value="Geen Points">Green Points to Teachers for distribution&nbsp;</li>
       ...
       <li><input type="checkbox" class="subpoint" name="permission[]" value="Blue Points To Student">Blue Points to Students for distribution&nbsp;</li>
                   ...
                   <td style="vertical-align:top; ">
                      <ul style="list-style-type:none; margin-left: -20px;">
     <li><input type="checkbox" class="sublog" name="permission[]" value="Teacher Geen Points">Teachers log of Green Points distributed&nbsp;</li>
     <li><input type="checkbox" class="sublog" name="permission[]" value="Student Geen Points"> Student log of Green Points received&nbsp;</li>
     <li><input type="checkbox" class="sublog" name="permission[]" value="Sponsor"> Sponsers log of points and products&nbsp;</li>
     <li><input type="checkbox" class="sublog" name="permission[]" value="Teacher Blue Point">Teacher log of Blue Points Received&nbsp;</li>
                      </ul>
                    </td>
	  ...
	  <div class='col-md-1'>
           <input type="reset" class='btn-lg btn-danger' value="Reset" style="padding:5px;" />
                 </div>
				 
			<div class="col-md-1 col-md-offset-1" style="padding:10px;">
                    <a href="scadmin_dashboard.php"><input type="button" class='btn-lg btn-danger' name="Back" value="Back" style="width:60%; background-color:#0080C0; color:#FFFFFF;"/></a>
             </div>	
