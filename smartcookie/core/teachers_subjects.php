...
<div class="container"  style="padding:30px;" >
            	...
            	<div style="border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="row">
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;
                       <a href="Add_teacher_subject.php"> <input type="submit" class="btn btn-primary" name="submit" value="Add Teacher" style="width:150;font-weight:bold;font-size:14px;"/></a>
               			 </div>
             ...
             <div class="col-md-12  " id="no-more-tables" >
               ...
               <?php $i=0;?>
                  ...
                  <table class="table-bordered" id="example" >
                     <thead>
                    	<tr style="background-color:#555;color:#FFFFFF;height:30px;"><th style="width:50px;" ><b><center>Sr.No</center></b><th style="width:350px;" ><center>Teacher ID</center></th><th style="width:350px;" ><center>Teacher Name</center></th></th><th style="width:150px;" ><center>Subject Code</center></th><th style="width:350px;" ><center>Subject Title</center></th><th style="width:350px;"><center>Branch</center></th><th style="width:50px;" ><center>Semester</center></th><th style="width:350px;" ><center>Division Name</center></th></tr></thead><tbody>
                 <?php
				
				   $i=1;
				  
				  $arr=mysql_query("select school_id,teacher_id,subjcet_code,subjectName,Division_id,Semester_id,Branches_id,Department_id from tbl_teacher_subject_master where teacher_id='$t_id'");?>
                  <?php while($row=mysql_fetch_array($arr))
				  {
                 ...
                 <tr style="height:30px;color:#808080;">
                    <th style="width:50px;"><b><center><?php echo $i;?></center></b></th>
                    <th style="width:100px;" ><center><?php echo $row['teacher_id'];?> </center></th>
                      
                     <?php 
					             
					 $getteachername=mysql_query("select * from tbl_teacher where t_id=".$teacher_id."");
					           while($getRows=mysql_fetch_array($getteachername))
							   {
									   $name=$getRows['t_name'];
										$Mname=$getRows['t_middlename'];
										$Lname=$getRows['t_lastname'];
