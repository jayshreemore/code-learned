...
mysql_query("update tbl_school_admin set thanqu_flag='$flag' where id='$id'");

header("Location:school_settings.php?report=".$report."&flag=".$flag);
}
}
?>
<html>
...
<div style="border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
    ...
    <div class="row" style="font-size:23px;font-weight:bold;color:#03F; " align="center">
...
<div style="border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
 ...
 <div class="col-md-8"> <h3><center>Who can give Blue Points to Teacher ?</h3></div>
   </div>
...
<input type="checkbox" name="check_list[]" value="School_Admin" checked>&nbsp;&nbsp;School Admin<br/>

<?php
$te="Te";
$pos1 = strpos($thanqu_flag,$te);
 if($pos1 !== false){?>
<input type="checkbox" name="check_list[]" value="Teacher" checked>&nbsp;&nbsp;Teacher<br/>
<?php }else{?>
<input type="checkbox" name="check_list[]" value="Teacher" >&nbsp;&nbsp;Teacher<br/>
<?php }?>


<?php
$te="St";
$pos2 = strpos($thanqu_flag,$te);
 if($pos2 !== false){?>
<input type="checkbox" name="check_list[]" value="Student" checked>&nbsp;&nbsp;Student<br/>
<?php }else{?>
<input type="checkbox" name="check_list[]" value="Student" >&nbsp;&nbsp;Student<br/>
<?php }?>
...
<?php
$te="Pa";
$pos3 = strpos($thanqu_flag,$te);
 if($pos3 !== false){?>
<input type="checkbox" name="check_list[]" value="Parent" checked>&nbsp;&nbsp;Parent<br/>
<?php }else{?>
<input type="checkbox" name="check_list[]" value="Parent" >&nbsp;&nbsp;Parent<br/>
<?php }?>
</div>
</div>
<div class="row">
