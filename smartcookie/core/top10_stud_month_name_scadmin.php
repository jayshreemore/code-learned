...
function display_top10_students()
{
	   ...
	   var school_id =document.getElementById("dropdownMenu1").value;
 		//alert(school_id );
        ...
        xmlhttp.open("GET","top10_stud_school_name_scadmin.php?school_id=" +school_id ,true);
        xmlhttp.send();
...
<div class="panel panel-info ">
 ...
 <div class="row">
  <div class="col-md-4">
<select name="limit" class="dropdownMenu1" id="dropdownMenu1" style="width:65%; height:30px; border-radius:2px;margin-left:105px;margin-top:20px;" onChange="display_top10_students()">
  
 
   <?php $sql1=mysql_query("Select id,school_name from tbl_school order by `school_name` ASC" );?>
 
    <option value="" disabled selected>School/College Name</option>
...
Duration
    ...
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_week_name_scadmin.php">Week </a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_month_name_scadmin.php">Month</a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_year_name_scadmin.php">Year</a></li>
...
Subject/Activity
  ...
  <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu1">
   ...
   <li role="presentation" class="divider"></li>
	...
	<li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_subject_name_scadmin.php?id=<?php echo $row['id'];?>"><?php echo $row['subject'];?><?php }?></a></li>
	...
	<li role="presentation"><a role="menuitem" tabindex="-1" href="top10_stud_activity_name_scadmin.php?id=<?php echo $row['school_id'];?>&sc_id=<?php echo $row['sc_id'];?>"><?php echo $row['sc_list'];?><?php }?></a></li>
				  ...
				  <div class='container-fluid'>
					...
					<thead align="center">
						<tr class="warning" >
							...
							<th><?php echo $dynamic_student." ".$dynamic_school."";?></th>
							<th>Week</th>
							<th>Points</th>
						</tr>
					</thead>
