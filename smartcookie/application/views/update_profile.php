...
<?php }?>
									...
									<a href="<?php echo base_url().'main/remove_profile_image'?>"><button type="button" class="btn btn-success">Remove</button></a>                       
                            ...
                            <div class="col-md-9">
                                    ...
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        ...
                                        <form action="#" class="form-horizontal"><h3><?php echo ($this->session->userdata('usertype')=='employee')?'Organization ':'Education'; ?> Details</h3>
                                         <div class="form-group"><label class="col-sm-3 control-label"><?php echo ($this->session->userdata('usertype')=='employee')?'Employee Id':'Student PRN'; ?></label>
...
echo "";															
											...
											<div class="form-group"><label class="col-sm-3 control-label">Middle Name<span class="mandatory">*</span></label>
                                          ...
                                          <?php */?>
                                            ...
                                            <h3>Contact Details</h3>
                                             <div class="form-group"><label class="col-sm-3 control-label">External Email<span class="mandatory">*</span></label>
											...
											<div class="form-group"><label class="col-sm-3 control-label">Internal Email<span class="mandatory">*</span></label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                       ...
                                                       <?php
													   if(isset($studentinfo[0]->country_code))
													   {
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Address<span class="mandatory">*</span></label>
