                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-black">
                                            ...
                                            <div class="panel-body pan">
                                                <?php 
echo form_open('main/teacher_register','class="form-horizontal"');?>
                                                    ...
                                                    <div class="form-actions text-right pal" style="background:#FFF;">
                                                        ...
                                                        &nbsp;
                                                        <a href="infoteacher" style="text-decoration:none;"><button type="button" class="btn btn-green">Cancel</button></a>
                                                    </div>
                                             <?php
