...
echo form_open('main/student_register','class="form-horizontal"');?>
                                                    ...
                                                    <div class="form-body pal"><h3>Personal</h3>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group"><label for="inputFatherName" class="col-md-3 control-label">Father Name<span class='require'>*</span></label>

                                                                    <div class="col-md-9" ><input id="inputFatherName" type="text" placeholder="Father Name" name="inputFatherName" class="form-control"/><?php echo form_error('inputFatherName', '<div class="error">', '</div>'); ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                           <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group"><label for="inputLastName" class="col-md-3 control-label">Last Name <span class='require'>*</span></label>
                                                                    ...
                                                                    <div class="col-md-9"><input id="inputLastName" type="text" placeholder="Last Name" name="inputLastName" class="form-control" value="<?php echo $this->input->post('inputLastName')?>"/><?php echo form_error('inputLastName', '<div class="error">', '</div>'); ?>
</div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group"><label for="Roll_No" class="col-md-3 control-label">PRN No. <span class='require'>*</span></label>

                                                                    <div class="col-md-9" ><input id="inputPRN" type="text" placeholder="PRN No." name="inputPRN" class="form-control"/><?php echo form_error('inputPRN', '<div class="error">', '</div>'); ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                          ...
                                                          <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group"><label for="inputEducation" class="col-md-3 control-label">Class <span class='require'>*</span></label>

                                                                    <div class="col-md-9"><input id="inputClass" type="text" placeholder="Class" class="form-control" name="inputClass"/><?php echo form_error('inputClass', '<div class="error">', '</div>'); ?></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group"><label for="inputDivision" class="col-md-3 control-label">Division <span class='require'>*</span></label>

                                                                    <div class="col-md-9"><input id="inputDivision" type="text" placeholder="Division" class="form-control" name="inputDivision"/><?php echo form_error('inputDivision', '<div class="error">', '</div>'); ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                    ...
                                                    <div class="form-actions text-right pal" style="background:#FFF;">
                                                        ...
                                                        &nbsp;
                                                        <a href="../controllers/infostudent" style="text-decoration:none;"><button type="button" class="btn btn-green">Cancel</button></a>
                                                    </div>
                                             <?php
